 ...
 *
 * Requirements: Task 5.1.5, Requirement 23.5
 */
...
class OCRUploadManager {
        ...
        try {
            ...
            if (data.success) {
                ...
                document.getElementById("max-file-size").textContent =
                    `${(this.maxFileSize / 1048576).toFixed(0)} MB`;
            } else {
    ...
    updateStatusCard(status) {
        ...
        if (status.ocr_available && status.image_processing_available) {
            ...
            `;
            statusCard.querySelector("p").textContent =
            ...
            `;
            statusCard.querySelector("p").textContent =
                "OCR system is currently unavailable";
        }
    }
    ...
    setupEventListeners() {
        ...
        // Process all button
        document
            .getElementById("process-all-button")
        ...
        // Clear queue button
        document
            .getElementById("clear-queue-button")
            ?.addEventListener("click", () => {
                this.clearQueue();
            });
    }
            ...
            <div id="queue-item-${fileId}" class="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <div class="flex items-center justify-between mb-2">
                    ...
                    <div class="flex items-center ml-4">
                        ...
                        <button type="button" 
                                onclick="ocrManager.removeFromQueue('${fileId}')"
                                class="ml-2 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 focus:outline-none"
