...
const NAV_ITEMS = [
  ...
  { id:'reports',        label:'Career Reports',  icon:'chart',    section:'main' },
  { id:'race-targets',  label:'Race Targets',    icon:'flag',     section:'main' },
  { id:'skill-loadout',  label:'Skill Loadout',  icon:'sparkles', section:'main' },
  { id:'card-collection',label:'Card Collection', icon:'squares',  section:'main' },
  { id:'mcp',            label:'MCP Monitor',    icon:'signal',   section:'system' },
  { id:'performance',    label:'Performance',    icon:'chart',    section:'system' },
  { id:'external-sync',  label:'External Sync',  icon:'database', section:'system' },
  { id:'ai-budget',      label:'AI Budget',      icon:'sparkles', section:'system' },
