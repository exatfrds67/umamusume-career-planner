<div class="space-y-6">
    ...
    {{-- Notification Types --}}
    <div class="space-y-4">
        <h3 class="text-lg font-medium text-gray-900 dark:text-white">Notification Types</h3>

        {{-- Race Reminders --}}
        <div class="flex items-center justify-between">
            <div>
                <label for="race-reminders" class="text-sm font-medium text-gray-700 dark:text-gray-300">Race Reminders</label>
        ...
        <div class="flex items-center justify-between">
            <div>
                <label for="training-alerts" class="text-sm font-medium text-gray-700 dark:text-gray-300">Training Alerts</label>
        ...
        <div class="flex items-center justify-between">
            <div>
                <label for="sync-notifications" class="text-sm font-medium text-gray-700 dark:text-gray-300">Sync Notifications</label>
