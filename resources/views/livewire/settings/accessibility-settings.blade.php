<div>
    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <label for="high-contrast-toggle" class="text-sm font-medium text-neutral-700 dark:text-neutral-300">
                            High Contrast Mode
                        </label>
                    ...
                    <button type="button" id="high-contrast-toggle"
                        ...
                        class="relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-hidden focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 {{ $highContrast ? 'bg-primary-600' : 'bg-neutral-200 dark:bg-neutral-600' }}"
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <label for="reduced-motion-toggle" class="text-sm font-medium text-neutral-700 dark:text-neutral-300">
                            Reduced Motion
                        </label>
                        <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    ...
                    <button type="button" id="reduced-motion-toggle"
                        ...
                        class="relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-hidden focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 {{ $reducedMotion ? 'bg-primary-600' : 'bg-neutral-200 dark:bg-neutral-600' }}"
                ...
                {{-- Font Size --}}
                <div>
                    <label for="font-size-select" class="block text-sm font-medium text-neutral-700 dark:text-neutral-300">
                        Font Size
                    </label>
                ...
                {{-- Color Blind Mode --}}
                <div>
                    <label for="colorblind-select" class="block text-sm font-medium text-neutral-700 dark:text-neutral-300">
                        Color Blind Mode
                    </label>
        ...
        <div class="pt-6 border-t border-neutral-200 dark:border-neutral-700">
            <h4 class="text-sm font-medium text-neutral-900 dark:text-white mb-3">Focus & Navigation</h4>
            <div class="space-y-4">
                {{-- Enhanced Focus Indicators --}}
                <div class="flex items-center justify-between">
                    <div>
                        <label for="focus-indicators-toggle" class="text-sm font-medium text-neutral-700 dark:text-neutral-300">
                            Enhanced Focus Indicators
                        </label>
                        <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    ...
                    <button type="button" id="focus-indicators-toggle"
                        ...
                        class="relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-hidden focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 {{ $focusIndicators ? 'bg-primary-600' : 'bg-neutral-200 dark:bg-neutral-600' }}"
        ...
        <div class="pt-6 border-t border-neutral-200 dark:border-neutral-700">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <label for="screen-reader-toggle" class="text-sm font-medium text-neutral-700 dark:text-neutral-300">
                            Screen Reader Optimization
                        </label>
                        <p class="text-sm text-neutral-500 dark:text-neutral-400">
                    ...
                    <button type="button" id="screen-reader-toggle"
                        ...
                        class="relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-hidden focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 {{ $screenReaderOptimization ? 'bg-primary-600' : 'bg-neutral-200 dark:bg-neutral-600' }}"
        ...
        <div class="pt-6 border-t border-neutral-200 dark:border-neutral-700 flex justify-end gap-3">
            <button type="button" wire:click="resetToDefaults"
                class="inline-flex items-center rounded-md bg-white dark:bg-neutral-700 px-3 py-2 text-sm font-semibold text-neutral-900 dark:text-white shadow-xs ring-1 ring-inset ring-neutral-300 dark:ring-neutral-600 hover:bg-neutral-50 dark:hover:bg-neutral-600">
                Reset to Defaults
            </button>
        </div>
    </div>
