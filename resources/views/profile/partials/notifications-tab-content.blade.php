    ...
    <div class="px-4 py-5 sm:p-6">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center justify-between py-3 border-b border-neutral-200 dark:border-neutral-700">
                <div class="flex-1">
                    <label for="notif_email" class="text-sm font-medium text-neutral-900 dark:text-white cursor-pointer">Email Notifications</label>
                ...
                <div>
                    ...
                    <input type="checkbox" id="notif_email" name="preferences[notifications][email]" value="1"
            ...
            <div class="flex items-center justify-between py-3 border-b border-neutral-200 dark:border-neutral-700">
                <div class="flex-1">
                    <label for="notif_training" class="text-sm font-medium text-neutral-900 dark:text-white cursor-pointer">Training Reminders</label>
                ...
                <div>
                    ...
                    <input type="checkbox" id="notif_training" name="preferences[notifications][training_reminders]" value="1"
            ...
            <div class="flex items-center justify-between py-3 border-b border-neutral-200 dark:border-neutral-700">
                <div class="flex-1">
                    <label for="notif_race" class="text-sm font-medium text-neutral-900 dark:text-white cursor-pointer">Race Alerts</label>
                ...
                <div>
                    ...
                    <input type="checkbox" id="notif_race" name="preferences[notifications][race_alerts]" value="1"
            ...
            <div class="flex items-center justify-between py-3">
                <div class="flex-1">
                    <label for="notif_ai" class="text-sm font-medium text-neutral-900 dark:text-white cursor-pointer">AI Recommendations</label>
                ...
                <div>
                    ...
                    <input type="checkbox" id="notif_ai" name="preferences[notifications][ai_recommendations]" value="1"
