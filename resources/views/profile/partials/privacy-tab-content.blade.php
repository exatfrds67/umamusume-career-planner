        ...
        <div class="space-y-6">
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between py-3 border-b border-neutral-200 dark:border-neutral-700">
                    <div class="flex-1">
                        <label for="privacy_local_first" class="text-sm font-medium text-neutral-900 dark:text-white cursor-pointer">Local-First Storage</label>
                    ...
                    <input type="checkbox" name="preferences[privacy][local_first]" id="privacy_local_first" value="1"
                ...
                <div class="flex items-center justify-between py-3 border-b border-neutral-200 dark:border-neutral-700">
                    <div class="flex-1">
                        <label for="ai_enable_cloud" class="text-sm font-medium text-neutral-900 dark:text-white cursor-pointer">Cloud AI Features</label>
                    ...
                    <input type="checkbox" name="ai_settings[enable_cloud_ai]" id="ai_enable_cloud" value="1"
                ...
                <div class="flex items-center justify-between py-3 border-b border-neutral-200 dark:border-neutral-700">
                    <div class="flex-1">
                        <label for="mcp_enable_external_apis" class="text-sm font-medium text-neutral-900 dark:text-white cursor-pointer">External API Integration</label>
                    ...
                    <input type="checkbox" name="mcp_settings[enable_external_apis]" id="mcp_enable_external_apis" value="1"
                ...
                <div class="flex items-center justify-between py-3">
                    <div class="flex-1">
                        <label for="mcp_enable_analytics" class="text-sm font-medium text-neutral-900 dark:text-white cursor-pointer">Usage Analytics</label>
                    ...
                    <input type="checkbox" name="mcp_settings[enable_analytics]" id="mcp_enable_analytics" value="1"
    ...
    <div class="px-4 py-5 sm:p-6">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center justify-between py-3 border-b border-neutral-200 dark:border-neutral-700">
                ...
                <a href="{{ route('profile.export') }}" class="btn btn-sm btn-secondary">
                    Export Data
                </a>
            </div>
