        ...
        <div class="space-y-6">
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex-1">
                        <label for="privacy_local_first" class="text-sm font-medium text-gray-900 dark:text-white cursor-pointer">Local-First Storage</label>
                ...
                <div class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex-1">
                        <label for="ai_enable_cloud" class="text-sm font-medium text-gray-900 dark:text-white cursor-pointer">Cloud AI Features</label>
                ...
                <div class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex-1">
                        <label for="mcp_enable_external_apis" class="text-sm font-medium text-gray-900 dark:text-white cursor-pointer">External API Integration</label>
                ...
                <div class="flex items-center justify-between py-3">
                    <div class="flex-1">
                        <label for="mcp_enable_analytics" class="text-sm font-medium text-gray-900 dark:text-white cursor-pointer">Usage Analytics</label>
