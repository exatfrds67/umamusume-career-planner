...
@section('content')
    {{-- Hero Section --}}
    <section class="py-16 md:py-24 bg-linear-to-br from-primary-50 to-primary-100 dark:from-neutral-800 dark:to-neutral-900"
        aria-labelledby="about-heading">
        <div class="container mx-auto px-4 text-center">
            <h1 id="about-heading" class="text-4xl md:text-5xl lg:text-6xl font-bold text-neutral-900 dark:text-white mb-6">
                Master Your Umamusume Training
            </h1>
            <p class="text-lg md:text-xl text-neutral-700 dark:text-neutral-300 max-w-3xl mx-auto leading-relaxed">
    ...
    {{-- Features Section --}}
    <section id="features" class="py-16 md:py-24 bg-white dark:bg-neutral-900" aria-labelledby="features-heading">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h2 id="features-heading"
                    class="text-3xl md:text-4xl lg:text-5xl font-bold text-neutral-900 dark:text-white mb-4">
                    Powerful Training Tools
                </h2>
                <p class="text-lg md:text-xl text-neutral-600 dark:text-neutral-400 max-w-3xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <article
                    class="bg-white dark:bg-neutral-800 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-200 border border-neutral-200 dark:border-neutral-700">
                    <div
                    ...
                    <h3 class="text-xl font-semibold text-neutral-900 dark:text-white mb-3">AI Training Recommendations</h3>
                ...
                <article
                    ...
                    <h3 class="text-xl font-semibold text-neutral-900 dark:text-white mb-3">Comprehensive Stat Tracking</h3>
                    <p class="text-neutral-600 dark:text-neutral-400 leading-relaxed">
                ...
                <article
                    ...
                    <h3 class="text-xl font-semibold text-neutral-900 dark:text-white mb-3">Advanced Skill Management</h3>
                    <p class="text-neutral-600 dark:text-neutral-400 leading-relaxed">
                ...
                <article
                    ...
                    <h3 class="text-xl font-semibold text-neutral-900 dark:text-white mb-3">Support Card Optimization</h3>
                    <p class="text-neutral-600 dark:text-neutral-400 leading-relaxed">
                ...
                <article
                    ...
                    <h3 class="text-xl font-semibold text-neutral-900 dark:text-white mb-3">URA & Unity Cup Support</h3>
                    <p class="text-neutral-600 dark:text-neutral-400 leading-relaxed">
                ...
                <article
                    ...
                    <h3 class="text-xl font-semibold text-neutral-900 dark:text-white mb-3">Privacy & Accessibility</h3>
                    <p class="text-neutral-600 dark:text-neutral-400 leading-relaxed">
    ...
    <section class="py-16 md:py-24 bg-primary-600 dark:bg-primary-700" aria-labelledby="cta-heading">
        <div class="container mx-auto px-4 text-center">
            ...
            <a href="{{ route('dashboard') }}"
                class="inline-flex items-center justify-center px-10 py-5 text-lg font-semibold text-primary-600 bg-white hover:bg-neutral-50 rounded-lg shadow-xl hover:shadow-2xl transition-all duration-200 focus:outline-hidden focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-600"
