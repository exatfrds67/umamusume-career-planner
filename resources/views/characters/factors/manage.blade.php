    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <a href="{{ route('characters.show', $character) }}"
                class="inline-flex items-center text-sm font-medium text-neutral-500 hover:text-neutral-700 dark:text-neutral-400 dark:hover:text-neutral-300 transition-colors">
            ...
            <div class="flex items-center space-x-3">
                <h1 class="text-2xl font-bold text-neutral-900 dark:text-white">Manage Factors</h1>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            @php
                ...
                $factorTypeColors = [
                    '1_star' => 'bg-neutral-100 text-neutral-800 dark:bg-neutral-800 dark:text-neutral-200',
                ...
                <div class="glass-card-alt rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-neutral-900 dark:text-white">{{ $count }}</p>
                        </div>
                        <div class="flex items-center">
                            @for ($i = 1; $i <= 3; $i++)
                                <svg class="w-4 h-4 {{ $i <= (int) str_replace('_star', '', $starLevel) ? 'text-yellow-400' : 'text-neutral-300 dark:text-neutral-600' }}"
            ...
            <div class="glass-card-alt rounded-lg p-4">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-neutral-600 dark:text-neutral-400">Total Factors</p>
                        <p class="text-2xl font-bold text-neutral-900 dark:text-white">{{ array_sum($factorCounts) }}</p>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1">
                <div class="glass-card-alt rounded-lg">
                    <div class="card-header bg-transparent border-b border-neutral-200/50 dark:border-neutral-700/50">
                        <h3 class="text-lg font-bold text-neutral-900 dark:text-white">Add New Factor</h3>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('characters.factors.store', $character) }}" method="POST" class="space-y-4">
                            ...
                            <div>
                                ...
                                <select name="factor_type" id="factor_type" required
                                    class="w-full rounded-md border-neutral-300 dark:border-neutral-600 dark:bg-neutral-700 dark:text-white shadow-xs focus:border-primary-500 focus:ring-primary-500">
            ...
            <div class="lg:col-span-2">
                <div class="glass-card-alt rounded-lg">
                    <div class="card-header bg-transparent border-b border-neutral-200/50 dark:border-neutral-700/50">
                        <h3 class="text-lg font-bold text-neutral-900 dark:text-white">Current Factors</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="space-y-6">
                                @foreach ($factorsByType as $type => $factors)
                                    @if ($factors->count() > 0)
                                        <div>
                                            <h4
                                                class="text-sm font-semibold text-neutral-500 uppercase tracking-wider mb-3 flex items-center gap-2">
                                                <div
                                                ...
                                                <span class="text-neutral-400">({{ $factors->count() }})</span>
                                            </h4>
                                            <div class="space-y-2">
                                                @foreach ($factors as $factor)
                                                    <div
                                                        class="flex items-center justify-between p-3 rounded-lg bg-neutral-50 dark:bg-neutral-800/50 border border-neutral-100 dark:border-neutral-700 {{ !$factor->is_active ? 'opacity-50' : '' }}">
                                                        <div class="flex items-center gap-3">
                                                            ...
                                                            <div>
                                                                <div class="flex items-center gap-2">
                                                                    ...
                                                                    @if (!$factor->is_active)
                                                                        <span
                                                                            class="text-xs text-neutral-400 bg-neutral-200 dark:bg-neutral-700 px-1.5 py-0.5 rounded">
                                                                            Inactive
                                                                        </span>
                                                                    @endif
                                                                </div>
                        ...
                        @else
                            <div class="text-center text-neutral-500 py-12">
                                <svg class="mx-auto h-12 w-12 text-neutral-400 mb-4" fill="none" viewBox="0 0 24 24"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                                </svg>
                                <h3 class="text-lg font-medium text-neutral-900 dark:text-white mb-2">No factors yet</h3>
                                <p class="text-neutral-500 dark:text-neutral-400 mb-4">Add your first inherited factor using the
                                    form on the left.</p>
                            </div>
                        @endif
                    </div>
