...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8">
        <!-- Page Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-neutral-900 dark:text-white">Data Migration</h1>
        ...
        <div class="mb-6 border-b border-neutral-200 dark:border-neutral-700">
            <nav class="-mb-px flex gap-4" aria-label="Migration tabs" role="tablist">
                <button type="button"
                    class="tab-btn active px-4 py-2 text-sm font-medium border-b-2 border-blue-500 text-blue-600 dark:text-blue-400"
                    id="tab-btn-convert" data-tab="convert" role="tab" aria-selected="true" aria-controls="tab-convert" tabindex="0">
                    Format Conversion
                </button>
                <button type="button"
                    class="tab-btn px-4 py-2 text-sm font-medium border-b-2 border-transparent text-neutral-500 hover:text-neutral-700 dark:text-neutral-400"
                    id="tab-btn-batch" data-tab="batch" role="tab" aria-selected="false" aria-controls="tab-batch" tabindex="-1">
                    Batch Import
                </button>
                <button type="button"
                    class="tab-btn px-4 py-2 text-sm font-medium border-b-2 border-transparent text-neutral-500 hover:text-neutral-700 dark:text-neutral-400"
                    id="tab-btn-validate" data-tab="validate" role="tab" aria-selected="false" aria-controls="tab-validate" tabindex="-1">
                    Validate Data
                </button>
                <button type="button"
                    class="tab-btn px-4 py-2 text-sm font-medium border-b-2 border-transparent text-neutral-500 hover:text-neutral-700 dark:text-neutral-400"
                    id="tab-btn-conflicts" data-tab="conflicts" role="tab" aria-selected="false" aria-controls="tab-conflicts" tabindex="-1">
                    Resolve Conflicts
                </button>
            </nav>
        </div>
        ...
        <div id="tab-convert" class="tab-content" role="tabpanel" aria-labelledby="tab-btn-convert">
            <div class="bg-white dark:bg-neutral-800 rounded-lg shadow-xs p-6">
                <h2 class="text-xl font-semibold text-neutral-900 dark:text-white mb-4">Convert Legacy Data Format</h2>
                ...
                <form id="convert-form" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select id="source-format" name="source_format"
                                class="w-full rounded-lg border-neutral-300 dark:border-neutral-600 dark:bg-neutral-700 dark:text-white focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <textarea id="convert-content" name="content" rows="12" required
                            class="w-full rounded-lg border-neutral-300 dark:border-neutral-600 dark:bg-neutral-700 dark:text-white focus:ring-blue-500 focus:border-blue-500 font-mono text-sm"
                            placeholder="Paste your legacy JSON, CSV, or text data here..."></textarea>
                    </div>

                    <div class="flex items-center gap-4">
                        <button type="button" id="detect-format-btn"
                            class="px-4 py-2 bg-neutral-100 dark:bg-neutral-700 text-neutral-700 dark:text-neutral-300 rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-600 transition-colors">
                            Detect Format
                        </button>
                        <button type="submit"
                ...
                <div id="convert-results" class="mt-6 hidden">
                    <h3 class="text-lg font-medium text-neutral-900 dark:text-white mb-4">Conversion Results</h3>
        ...
        <!-- Batch Import Tab -->
        <div id="tab-batch" class="tab-content hidden" role="tabpanel" aria-labelledby="tab-btn-batch">
            <div class="bg-white dark:bg-neutral-800 rounded-lg shadow-xs p-6">
                <h2 class="text-xl font-semibold text-neutral-900 dark:text-white mb-4">Batch Import Processing</h2>
                <p class="text-neutral-600 dark:text-neutral-400 mb-6">
                ...
                <div id="batch-progress" class="mt-6 hidden">
                    <h3 class="text-lg font-medium text-neutral-900 dark:text-white mb-4">Import Progress</h3>
                    <div class="space-y-4">
                        <div class="flex items-center justify-between text-sm">
                            <span class="text-neutral-600 dark:text-neutral-400">Status: <span id="batch-status"
                                    class="font-medium">-</span></span>
                            <span class="text-neutral-600 dark:text-neutral-400">Batch ID: <span id="batch-id"
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                            <div class="bg-neutral-50 dark:bg-neutral-700 rounded-lg p-3">
                                <div class="text-2xl font-bold text-neutral-900 dark:text-white" id="total-records">0</div>
                                <div class="text-xs text-neutral-500 dark:text-neutral-400">Total</div>
                            </div>
                            <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-3">
                                <div class="text-2xl font-bold text-green-600 dark:text-green-400"
                                    id="successful-records">0</div>
                                <div class="text-xs text-neutral-500 dark:text-neutral-400">Successful</div>
                            </div>
                            ...
                            <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-3">
                                <div class="text-2xl font-bold text-yellow-600 dark:text-yellow-400" id="skipped-records">
                                    0</div>
                                <div class="text-xs text-neutral-500 dark:text-neutral-400">Skipped</div>
                            </div>
                        </div>
        ...
        <!-- Validate Data Tab -->
        <div id="tab-validate" class="tab-content hidden" role="tabpanel" aria-labelledby="tab-btn-validate">
            <div class="bg-white dark:bg-neutral-800 rounded-lg shadow-xs p-6">
                <h2 class="text-xl font-semibold text-neutral-900 dark:text-white mb-4">Validate Data Before Import</h2>
                <p class="text-neutral-600 dark:text-neutral-400 mb-6">
                ...
                <form id="validate-form" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="validate-import-type" name="import_type" required
                            class="w-full md:w-1/3 rounded-lg border-neutral-300 dark:border-neutral-600 dark:bg-neutral-700 dark:text-white focus:ring-blue-500 focus:border-blue-500">
                            @foreach ($importTypes as $key => $label)
                                <option value="{{ $key }}">{{ $label }}</option>
                            @endforeach
                        </select>
                ...
                <div id="validate-results" class="mt-6 hidden">
                    <h3 class="text-lg font-medium text-neutral-900 dark:text-white mb-4">Validation Results</h3>
        ...
        <div id="tab-conflicts" class="tab-content hidden" role="tabpanel" aria-labelledby="tab-btn-conflicts">
            <div class="bg-white dark:bg-neutral-800 rounded-lg shadow-xs p-6">
                <h2 class="text-xl font-semibold text-neutral-900 dark:text-white mb-4">Resolve Import Conflicts</h2>
                <p class="text-neutral-600 dark:text-neutral-400 mb-6">
                    ...
                    <div class="flex items-end gap-4">
                        <div class="flex-1">
                            ...
                            <input type="text" id="conflict-batch-id"
                                class="w-full rounded-lg border-neutral-300 dark:border-neutral-600 dark:bg-neutral-700 dark:text-white focus:ring-blue-500 focus:border-blue-500 font-mono"
