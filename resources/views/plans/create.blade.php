...
<div class="relative z-10 container mx-auto px-4 py-8">
    ...
    <div x-data="planWizard({ mode: 'create' })" x-init="init()" class="max-w-5xl mx-auto">
        ...
        <x-stepper 
            ...
            x-bind:current="currentStep"
            x-bind:completed="completedSteps"
            class="mb-8"
        />
        ...
        <div x-show="currentStepErrors.length > 0" x-transition class="mb-6">
            <x-alert-banner 
                variant="error"
                x-bind:message="currentStepErrors.join(', ')"
            />
        </div>
        ...
        <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-lg shadow-lg p-6 mb-6">
            ...
            <div x-show="currentStep === 0" x-transition class="space-y-6">
                ...
                <p class="text-gray-600 dark:text-gray-400 mb-6">
                    Choose the character you want to create a training plan for. This will determine available aptitudes and growth rates.
                </p>
                ...
                <div x-show="plan.character_id" x-transition class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input 
                            type="number"
                            id="goal-speed"
                            x-model.number="plan.goals.target_speed"
                            @input="updateGoal('target_speed', $event.target.value)"
                            min="0"
                            max="1200"
                    ...
                    {{-- Stamina Goal --}}
                    <div>
                        <label for="goal-stamina" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Target Stamina
                        </label>
                        <input 
                            type="number"
                            id="goal-stamina"
                            x-model.number="plan.goals.target_stamina"
                            @input="updateGoal('target_stamina', $event.target.value)"
                            min="0"
                            max="1200"
                            class="w-full px-4 py-2 text-gray-900 dark:text-white bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900"
                            placeholder="e.g., 600"
                    ...
                    <div>
                        ...
                        <input 
                            type="number"
                            id="goal-power"
                            x-model.number="plan.goals.target_power"
                            @input="updateGoal('target_power', $event.target.value)"
                            min="0"
                            max="1200"
                            class="w-full px-4 py-2 text-gray-900 dark:text-white bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900"
                            placeholder="e.g., 700"
                    ...
                    <div>
                        ...
                        <input 
                            type="number"
                            id="goal-guts"
                            x-model.number="plan.goals.target_guts"
                            @input="updateGoal('target_guts', $event.target.value)"
                            min="0"
                            max="1200"
                            class="w-full px-4 py-2 text-gray-900 dark:text-white bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900"
                            placeholder="e.g., 500"
                    ...
                    <div>
                        ...
                        <input 
                            type="number"
                            id="goal-wit"
                            x-model.number="plan.goals.target_wit"
                            @input="updateGoal('target_wit', $event.target.value)"
                            min="0"
                            max="1200"
                            class="w-full px-4 py-2 text-gray-900 dark:text-white bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900"
                            placeholder="e.g., 600"
                    ...
                    <div>
                        ...
                        <input 
                            type="number"
                            id="goal-sp"
                            x-model.number="plan.goals.target_total_sp"
                            @input="updateGoal('target_total_sp', $event.target.value)"
                            min="0"
                            max="500"
                            class="w-full px-4 py-2 text-gray-900 dark:text-white bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900"
                            placeholder="e.g., 300"
            ...
            <div x-show="currentStep === 2" x-transition class="space-y-6">
                ...
                <div x-show="plan.skills.length > 0" x-transition class="mt-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="font-medium text-gray-900 dark:text-white">
                                <span x-text="plan.skills.length"></span> skill<span x-show="plan.skills.length !== 1">s</span> selected
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div x-show="currentStep === 4" x-transition class="space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <p class="text-gray-600 dark:text-gray-400" x-text="plan.character_name || 'Not selected'"></p>
                    </div>
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
                            <div x-show="plan.goals.target_speed">
                                ...
                                <span class="font-medium text-gray-900 dark:text-white ml-1" x-text="plan.goals.target_speed"></span>
                            </div>
                            <div x-show="plan.goals.target_stamina">
                                <span class="text-gray-600 dark:text-gray-400">Stamina:</span>
                                <span class="font-medium text-gray-900 dark:text-white ml-1" x-text="plan.goals.target_stamina"></span>
                            </div>
                            <div x-show="plan.goals.target_power">
                                <span class="text-gray-600 dark:text-gray-400">Power:</span>
                                <span class="font-medium text-gray-900 dark:text-white ml-1" x-text="plan.goals.target_power"></span>
                            </div>
                            <div x-show="plan.goals.target_guts">
                                <span class="text-gray-600 dark:text-gray-400">Guts:</span>
                                <span class="font-medium text-gray-900 dark:text-white ml-1" x-text="plan.goals.target_guts"></span>
                            </div>
                            <div x-show="plan.goals.target_wit">
                                <span class="text-gray-600 dark:text-gray-400">Wit:</span>
                                <span class="font-medium text-gray-900 dark:text-white ml-1" x-text="plan.goals.target_wit"></span>
                            </div>
                            <div x-show="plan.goals.target_total_sp">
                                <span class="text-gray-600 dark:text-gray-400">Total SP:</span>
                                <span class="font-medium text-gray-900 dark:text-white ml-1" x-text="plan.goals.target_total_sp"></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">
                            <span x-text="plan.skills.length || 0"></span> skill<span x-show="plan.skills.length !== 1">s</span>
                        </p>
                    </div>
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">
                            <span x-text="plan.races.length || 0"></span> race<span x-show="plan.races.length !== 1">s</span>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                >
                    ...
                    <svg x-show="!isLastStep && !isSubmitting" class="w-4 h-4 inline-block ml-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
