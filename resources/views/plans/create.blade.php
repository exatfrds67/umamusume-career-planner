        ...
        <div x-data="planWizard({ mode: 'create' })" x-init="init()" class="max-w-5xl mx-auto">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <div>
                        <h1 class="text-3xl font-bold text-neutral-900 dark:text-white">Create Career Plan</h1>
            ...
            <div class="bg-white/90 dark:bg-neutral-800/90 backdrop-blur-xs rounded-lg shadow-lg p-6 mb-6">
                ...
                <div x-show="currentStep === 0" x-transition class="space-y-6">
                    ...
                    {{-- Star Level Selector --}}
                    <div x-show="plan.character_id" x-transition
                        class="mt-6 p-5 bg-white dark:bg-neutral-700/50 border border-neutral-200 dark:border-neutral-600 rounded-lg">
