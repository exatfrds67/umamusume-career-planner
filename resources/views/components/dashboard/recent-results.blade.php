    ...
    <div class="px-6 py-5">
        ...
        @if (empty($results))
            <div class="text-center py-5">
                ...
                <p class="text-sm font-medium text-neutral-900 dark:text-neutral-200 mb-1">
                    No recent activity
                </p>
                    ...
                    @foreach ($results as $index => $result)
                        ...
                        <li>
                            <div class="relative {{ !$isLast ? 'pb-8' : '' }}">
                                @if (!$isLast)
                                    <span class="absolute left-4 top-4 -ml-px h-full w-0.5 bg-neutral-200 dark:bg-neutral-700"
                                        aria-hidden="true"></span>
                                @endif
                                <div class="relative flex space-x-3">
                                    <div>
                                        <span
                                            class="h-8 w-8 rounded-full {{ $color }} flex items-center justify-center ring-8 ring-white dark:ring-neutral-800/20">
                                    ...
                                    <div class="glass-card-inner rounded-lg p-3 flex min-w-0 flex-1 justify-between space-x-4">
                                        ...
                                        <div
                                            class="text-right text-xs whitespace-nowrap text-neutral-500 dark:text-neutral-400">
