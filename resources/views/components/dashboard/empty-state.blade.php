...
<div class="text-center py-12">
    ...
    <div class="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-3 max-w-4xl mx-auto">
        <div class="bg-white dark:bg-neutral-800 rounded-lg shadow p-6 text-left">
            <div
            ...
            <h4 class="text-sm font-semibold text-neutral-900 dark:text-white mb-2">Track Stats</h4>
            <p class="text-xs text-neutral-500 dark:text-neutral-400">Monitor Speed, Stamina, Power, Guts, and Wit
        ...
        <div class="bg-white dark:bg-neutral-800 rounded-lg shadow p-6 text-left">
            ...
            <h4 class="text-sm font-semibold text-neutral-900 dark:text-white mb-2">Plan Races</h4>
            <p class="text-xs text-neutral-500 dark:text-neutral-400">Schedule races, track readiness, and optimize your race
                strategy.</p>
        </div>
        ...
        <div class="bg-white dark:bg-neutral-800 rounded-lg shadow p-6 text-left">
            ...
            <h4 class="text-sm font-semibold text-neutral-900 dark:text-white mb-2">Manage Skills</h4>
            <p class="text-xs text-neutral-500 dark:text-neutral-400">Acquire and optimize skills to maximize your character's
                potential.</p>
        </div>
    </div>
</div>
