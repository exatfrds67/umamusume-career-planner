...
@if($totalPages > 1)
    <nav class="flex items-center justify-between border-t border-neutral-200 dark:border-neutral-700 px-4 py-3 sm:px-0" aria-label="Pagination">
        {{-- Previous Button --}}
        <div class="w-0 flex-1">
            @if($currentPage > 1)
                <a
                    ...
                    class="relative inline-flex items-center gap-2 border border-neutral-300 dark:border-neutral-600 bg-white dark:bg-neutral-800 px-4 py-2 text-sm font-medium text-neutral-700 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-700 rounded-lg transition-colors"
                >
        ...
        <div class="hidden sm:flex items-center gap-1">
            @foreach($pagesToShow as $page)
                @if($page === '...')
                    <span class="text-neutral-700 dark:text-neutral-400 px-2">•••</span>
                @else
                    @php
                    ...
                    <a
                        ...
                        @else
                            relative inline-flex items-center border border-neutral-300 dark:border-neutral-600 bg-white dark:bg-neutral-800 px-4 py-2 text-sm font-medium text-neutral-700 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-700
    ...
    <div class="sm:hidden px-4 py-2 text-center text-sm text-neutral-700 dark:text-neutral-300">
