<div class="relative inline-block {{ $sizeClasses() }}" {{ $attributes }}>
    <div class="relative w-full h-full {{ $roundedClasses() }} {{ $borderClasses() }} bg-neutral-100 dark:bg-neutral-800">
        @if($image)
            <img 
                src="{{ $image }}" 
                alt="{{ $alt }}"
        ...
        @else
            ...
            <div class="w-full h-full flex items-center justify-center text-neutral-500 dark:text-neutral-400">
