...
@push('scripts')
    <script>
        function spiritBurstGauge(characterId, initialGauge, maxGauge) {
            return {
                ...
                init() {
                    ...
                    this.$watch('gauge', (value) => {
                        this.$dispatch('spirit-burst-gauge-changed', {
                            gauge: value,
                            maxGauge: this.maxGauge,
                            ready: value >= this.maxGauge
                        });
                    });

                    // Listen for teammate training events
                    window.addEventListener('training-with-teammates', (event) => {
                        if (event.detail.hasTeammates && this.gauge < this.maxGauge) {
                            this.incrementGauge();
                        }
                    });
                },
                ...
                async confirmTrigger() {
                    ...
                    try {
                        ...
                        this.$dispatch('spirit-burst-triggered', {
                        ...
                        console.error('Error triggering Spirit Burst:', error);
                    } finally {
                ...
                showReadyNotification() {
                    ...
                    console.log('Spirit Burst is ready to trigger!');
                },

                showSuccessNotification() {
                    // You can integrate with a toast notification system here
                    console.log('Spirit Burst triggered successfully!');
                }
            };
        }
    </script>
