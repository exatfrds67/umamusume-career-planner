...
<div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
    ...
    <div class="mb-6">
        <h4 class="mb-3 text-sm font-semibold text-gray-700 dark:text-gray-300">MCP Server Preferences</h4>
        <div class="space-y-3">
                ...
                <div
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <label :for="'server-' + name" class="flex-1 cursor-pointer">
                            <p class="text-sm font-medium text-gray-900 dark:text-white" x-text="server.name"></p>
                            <p class="text-xs text-gray-500 dark:text-gray-400" x-text="server.description"></p>
                        </label>
                    </div>
    ...
    <!-- Agent Configuration -->
    <div class="mb-6">
        <h4 class="mb-3 text-sm font-semibold text-gray-700 dark:text-gray-300">Default Agent Configuration</h4>
        <div class="space-y-4">
            <!-- Training Agent -->
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Training Optimization
                    Agent</label>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Skill Optimization
                    Agent</label>
    ...
    <!-- Budget Limits -->
    <div class="mb-6">
        <h4 class="mb-3 text-sm font-semibold text-gray-700 dark:text-gray-300">Budget Limits</h4>
        <div class="space-y-4">
            <!-- Daily Budget -->
            <div>
    ...
    <div class="mb-6">
        <h4 class="mb-3 text-sm font-semibold text-gray-700 dark:text-gray-300">Performance Preferences</h4>
        <div class="space-y-3">
            <!-- Auto-fallback -->
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Auto-fallback to Cloud</p>
            ...
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Parallel Agent Processing</p>
            ...
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Cache AI Responses</p>
