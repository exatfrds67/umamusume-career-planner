    ...
    <section class="py-16 md:py-24">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto">
                <h1 class="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white">Terms of Service</h1>
                ...
                <div class="mt-10 space-y-8">
                    <x-card class="bg-white dark:bg-gray-900 p-6 border border-gray-200 dark:border-gray-800">
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Acceptable Use</h2>
                    ...
                    <x-card class="bg-white dark:bg-gray-900 p-6 border border-gray-200 dark:border-gray-800">
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Data Ownership</h2>
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <x-card class="bg-white dark:bg-gray-900 p-6 border border-gray-200 dark:border-gray-800">
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Service Availability</h2>
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
