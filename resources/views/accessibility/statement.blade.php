    ...
    <section class="py-16 md:py-24">
        <div class="container mx-auto px-4">
            <div class="max-w-3xl mx-auto">
                <h1 class="text-4xl md:text-5xl font-bold text-neutral-900 dark:text-white">Accessibility Statement</h1>
                ...
                <div class="mt-10 space-y-8">
                    <x-card class="bg-white dark:bg-neutral-900 p-6 border border-neutral-200 dark:border-neutral-800">
                        <h2 class="text-xl font-semibold text-neutral-900 dark:text-white">Accessibility Commitment</h2>
                    ...
                    <x-card class="bg-white dark:bg-neutral-900 p-6 border border-neutral-200 dark:border-neutral-800">
                        <h2 class="text-xl font-semibold text-neutral-900 dark:text-white">Assistive Technology</h2>
                        <p class="mt-2 text-sm text-neutral-600 dark:text-neutral-400">
                    ...
                    <x-card class="bg-white dark:bg-neutral-900 p-6 border border-neutral-200 dark:border-neutral-800">
                        <h2 class="text-xl font-semibold text-neutral-900 dark:text-white">Feedback</h2>
                        <p class="mt-2 text-sm text-neutral-600 dark:text-neutral-400">
