...
<body class="bg-neutral-100 p-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <p class="text-neutral-600 mb-4">Base URL: <code
                    class="bg-neutral-100 px-2 py-1 rounded">https://api.umapyoi.net</code></p>
            ...
            <div id="umapyoi-results" class="bg-neutral-50 p-4 rounded border border-neutral-200 min-h-50">
                <p class="text-neutral-500">Click a button to test an endpoint. Check the browser console (F12) for
                    detailed logs.</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <p class="text-neutral-600 mb-4">Base URL: <code
                    class="bg-neutral-100 px-2 py-1 rounded">https://umamusumedb.com</code></p>
            ...
            <div id="umamusumedb-results" class="bg-neutral-50 p-4 rounded border border-neutral-200 min-h-50">
                <p class="text-neutral-500">Click a button to test. Check the browser console (F12) for detailed logs.</p>
            </div>
        </div>
