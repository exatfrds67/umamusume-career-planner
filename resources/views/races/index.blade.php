                        ...
                        <form action="{{ route('races.index') }}" method="GET" class="space-y-4">
                            ...
                            <div>
                                ...
                                <select name="grade" id="grade" class="form-select">
                                    ...
                                    @foreach (['G1', 'G2', 'G3', 'OP', 'Pre-OP'] as $grade)
                                        <option value="{{ $grade }}"
                                            {{ request('grade') === $grade ? 'selected' : '' }}>{{ $grade }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="distance" id="distance" class="form-select">
                                    ...
                                    @foreach (['Sprint', 'Mile', 'Medium', 'Long'] as $dist)
                                        <option value="{{ $dist }}"
                                            {{ request('distance') === $dist ? 'selected' : '' }}>{{ $dist }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="surface" id="surface" class="form-select">
                                    ...
                                    <option value="Turf" {{ request('surface') === 'Turf' ? 'selected' : '' }}>Turf
                                    </option>
                                    <option value="Dirt" {{ request('surface') === 'Dirt' ? 'selected' : '' }}>Dirt
                                    </option>
                                </select>
                            </div>
