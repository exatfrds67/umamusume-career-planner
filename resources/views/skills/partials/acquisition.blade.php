...
<div class="space-y-6">
    ...
    <div class="card bg-white dark:bg-neutral-800">
        <div class="card-header flex items-center justify-between">
            <h3 class="text-lg font-semibold text-neutral-900 dark:text-white">AI Recommendations</h3>
        ...
        <div class="card-body">
                ...
                <template x-for="rec in recommendations" :key="rec.skill_id">
                    <div class="p-4 border border-neutral-200 dark:border-neutral-700 rounded-lg">
                        <div class="flex items-start justify-between mb-2">
                            <div>
                                <h4 class="font-semibold text-neutral-900 dark:text-white" x-text="rec.skill_name"></h4>
                                <p class="text-sm text-neutral-600 dark:text-neutral-400" x-text="rec.reason"></p>
                            </div>
            ...
            <div x-show="recommendations.length === 0" class="text-center py-8 text-neutral-500 dark:text-neutral-400">
    ...
    <div class="card bg-white dark:bg-neutral-800">
        <div class="card-header">
            <h3 class="text-lg font-semibold text-neutral-900 dark:text-white">SP Planning</h3>
        </div>
        <div class="card-body space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="p-4 bg-neutral-50 dark:bg-neutral-700 rounded-lg">
                    <p class="text-sm text-neutral-600 dark:text-neutral-400">Available SP</p>
                    <p class="text-2xl font-bold text-neutral-900 dark:text-white" x-text="character?.available_sp || 0">
                    </p>
                </div>
                <div class="p-4 bg-neutral-50 dark:bg-neutral-700 rounded-lg">
                    <p class="text-sm text-neutral-600 dark:text-neutral-400">Planned Spending</p>
                    <p class="text-2xl font-bold text-neutral-900 dark:text-white" x-text="plannedSpending"></p>
                </div>
                <div class="p-4 bg-neutral-50 dark:bg-neutral-700 rounded-lg">
                    <p class="text-sm text-neutral-600 dark:text-neutral-400">Remaining</p>
            ...
            <div>
                <div class="flex items-center justify-between mb-2">
                    <span class="text-sm font-medium text-neutral-700 dark:text-neutral-300">SP Budget</span>
    ...
    <div class="card bg-white dark:bg-neutral-800">
        <div class="card-header">
            <h3 class="text-lg font-semibold text-neutral-900 dark:text-white">Recent Acquisitions</h3>
        </div>
        <div class="card-body">
            <div x-show="recentAcquisitions.length === 0" class="text-center py-8 text-neutral-500 dark:text-neutral-400">
            ...
            <div x-show="recentAcquisitions.length > 0" class="space-y-3">
                <template x-for="skill in recentAcquisitions" :key="skill.id">
                    <div class="flex items-center justify-between p-3 bg-neutral-50 dark:bg-neutral-700 rounded-lg">
                        <div>
                            <h4 class="font-medium text-neutral-900 dark:text-white" x-text="skill.name"></h4>
