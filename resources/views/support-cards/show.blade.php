                    ...
                    @foreach ($supportCard->unique_effects as $effect)
                        <li class="flex items-start gap-2">
                            @if (str_contains($effect, 'Event Skill:'))
                                <span
                                    class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-yellow-100 dark:bg-yellow-900/30 text-yellow-600 dark:text-yellow-400 text-xs shrink-0 mt-0.5">
