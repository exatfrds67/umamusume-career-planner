                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                <p
                                    class="text-lg font-semibold {{ $extraction->confidence_score >= 0.7 ? 'text-green-600' : ($extraction->confidence_score >= 0.5 ? 'text-yellow-600' : 'text-red-600') }}">
                ...
                <form id="correction-form" method="POST" action="{{ route('ocr.import', $extraction->id) }}">
                    ...
                    <div
                        ...
                        <div id="raw-text-content" class="hidden mt-4">
                            <pre
                                class="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg text-sm text-gray-700 dark:text-gray-300 overflow-x-auto whitespace-pre-wrap">{{ $extraction->extracted_text }}</pre>
                        </div>
                    </div>
