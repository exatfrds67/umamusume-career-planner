            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <input type="checkbox" name="preferences[privacy][local_first]" value="1"
                        <?php echo e(old('preferences.privacy.local_first', optional($user->preferences)['privacy']['local_first'] ?? false) ? 'checked' : ''); ?>
                ...
                <div class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <input type="checkbox" name="ai_settings[enable_cloud_ai]" value="1"
                        <?php echo e(old('ai_settings.enable_cloud_ai', optional($user->ai_settings)['enable_cloud_ai'] ?? true) ? 'checked' : ''); ?>
                ...
                <div class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <input type="checkbox" name="mcp_settings[enable_external_apis]" value="1"
                        <?php echo e(old('mcp_settings.enable_external_apis', optional($user->mcp_settings)['enable_external_apis'] ?? true) ? 'checked' : ''); ?>
                ...
                <div class="flex items-center justify-between py-3">
                    ...
                    <input type="checkbox" name="mcp_settings[enable_analytics]" value="1"
                        <?php echo e(old('mcp_settings.enable_analytics', optional($user->mcp_settings)['enable_analytics'] ?? false) ? 'checked' : ''); ?>
    ...
    <div class="px-4 py-5 sm:p-6">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700">
                ...
                <form action="<?php echo e(route('profile.export')); ?>" method="GET" class="inline">
            ...
            <div class="flex items-center justify-between py-3">
                ...
                <a href="<?php echo e(route('import.index')); ?>" class="btn btn-sm btn-secondary">
                    Import Data
                </a>
            </div>
        </div>
...
<?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/profile/partials/privacy-tab-content.blade.php ENDPATH**/ ?>