    ...
    <div class="space-y-6" x-data="supportCardManager()">
        ...
        <aside class="card bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700" aria-labelledby="stats-heading">
            ...
            <div class="flex flex-wrap items-center justify-between gap-4">
                <div class="flex items-center gap-6">
                    ...
                    <div class="flex gap-4">
                        ...
                        <?php $__currentLoopData = ['SSR' => 'text-yellow-500', 'SR' => 'text-purple-500', 'R' => 'text-blue-500']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="text-center">
                                <div class="text-lg font-semibold <?php echo e($color); ?>"><?php echo e($rarityCounts->get($r, 0)); ?></div>
                ...
                <?php if(auth()->check()): ?>
                <a href="<?php echo e(route('characters.index')); ?>" class="btn btn-primary flex items-center gap-2" title="Select a character to build a deck">
...
<?php endif; ?>
            ...
            <div x-show="viewMode === 'list'" class="space-y-3">
                <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if (isset($component)) { $__componentOriginal3ef0db50670c3d3afdbf35d6b035d88d = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3ef0db50670c3d3afdbf35d6b035d88d = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.support-card-list-item','data' => ['card' => $card]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('support-card-list-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3ef0db50670c3d3afdbf35d6b035d88d)): ?>
<?php $attributes = $__attributesOriginal3ef0db50670c3d3afdbf35d6b035d88d; ?>
<?php unset($__attributesOriginal3ef0db50670c3d3afdbf35d6b035d88d); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal3ef0db50670c3d3afdbf35d6b035d88d)): ?>
<?php $component = $__componentOriginal3ef0db50670c3d3afdbf35d6b035d88d; ?>
<?php unset($__componentOriginal3ef0db50670c3d3afdbf35d6b035d88d); ?>
<?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
