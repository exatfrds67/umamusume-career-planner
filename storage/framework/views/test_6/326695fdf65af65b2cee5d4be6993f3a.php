            ...
            <?php if(isset($character)): ?>
                <div
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white"><?php echo e($character->name); ?></h3>
                            <div class="flex items-center gap-4 mt-1 text-sm text-gray-600 dark:text-gray-400">
                                <span><?php echo e(ucfirst($character->scenario_type)); ?></span>
                                <span>•</span>
                                <span><?php echo e($character->career_stage); ?></span>
                                <?php if($character->relationLoaded('currentCareer') && $character->currentCareer): ?>
                                    <span>•</span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ai.chat-interface','data' => ['characterId' => $character->id ?? null,'careerId' => isset($character) && $character->relationLoaded('currentCareer') && $character->currentCareer
...
<?php endif; ?>
<?php $component->withAttributes(['character-id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($character->id ?? null),'career-id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(isset($character) && $character->relationLoaded('currentCareer') && $character->currentCareer
                    ? $character->currentCareer->id
                    : null)]); ?>
