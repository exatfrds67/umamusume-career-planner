...
<div <?php echo e($attributes->merge(['class' => 'glass-card rounded-xl overflow-hidden h-full flex flex-col'])); ?>>
    ...
    <div class="px-5 py-3 border-b border-gray-100 dark:border-gray-700/50 flex items-center justify-between shrink-0">
        ...
        <span class="text-xs text-gray-400 font-medium"><?php echo e($timestamp->shortAbsoluteDiffForHumans()); ?></span>
    </div>
    ...
    <div class="flex-1 p-5 overflow-y-auto space-y-4 bg-gray-50/50 dark:bg-gray-900/20">
        ...
        <div class="pl-9 space-y-2">
             <div class="flex flex-wrap gap-2">
                <a href="<?php echo e(route('ai.chat', ['topic' => 'training'])); ?>" 
                ...
                <a href="<?php echo e(route('ai.chat', ['topic' => 'race'])); ?>" 
    ...
    <div class="p-3 bg-white dark:bg-gray-800/50 border-t border-gray-100 dark:border-gray-700/50 shrink-0">
        <form action="<?php echo e(route('ai.chat')); ?>" method="GET" class="relative">
            <input type="text" 
...
<?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/components/dashboard/ai-advisor-card.blade.php ENDPATH**/ ?>