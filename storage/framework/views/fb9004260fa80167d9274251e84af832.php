...
<div <?php echo e($attributes->merge(['class' => 'stat-bar-container'])); ?>>
    ...
    <div
        ...
        <?php if($showSoftCap && $getSoftCapPercentage() < 100): ?>
        ...
        <?php if($getTargetPercentage() !== null): ?>
    ...
    <?php if($factorBonus && $factorBonus > 0): ?>
        <div
...
<?php if (! $__env->hasRenderedOnce('609e71d2-fa7e-4e6a-90f1-bcf229282cf8')): $__env->markAsRenderedOnce('609e71d2-fa7e-4e6a-90f1-bcf229282cf8'); ?>
