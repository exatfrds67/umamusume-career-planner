                ...
                <div class="flex items-center gap-4">
                    <div class="relative">
                        <img x-ref="avatarPreview"
                            ...
                            :src="previewUrl ||
                                '<?php echo e($user->avatar_url ?? 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&background=3b82f6&color=fff&size=128'); ?>'"
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex gap-2">
                            ...
                            <button type="button" @click="removeAvatar"
                                x-show="previewUrl || <?php echo e(!empty($user->attributes['avatar_path'] ?? null) ? 'true' : 'false'); ?>"
                                :disabled="uploading"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="bio" id="bio" rows="3" placeholder="Tell us about yourself..."
                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"><?php echo e(old('bio', $user->bio ?? '')); ?></textarea>
    ...
    <div class="px-4 py-5 sm:p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                ...
                <div class="mt-1 text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['characters_created']); ?>

                </div>
            </div>
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                <div class="text-sm font-medium text-gray-500 dark:text-gray-400">Training Sessions</div>
                <div class="mt-1 text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['training_sessions']); ?>

                </div>
            </div>
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
                <div class="text-sm font-medium text-gray-500 dark:text-gray-400">Races Completed</div>
                <div class="mt-1 text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($stats['races_completed']); ?>
...
<?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/profile/partials/account-tab-content.blade.php ENDPATH**/ ?>