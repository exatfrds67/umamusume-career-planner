...
<?php $component = App\View\Components\Breadcrumb::resolve(['items' => [['label' => 'Dashboard']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
        ...
        <div class="glass-card rounded-xl p-6 md:flex md:items-center md:justify-between">
            <div class="min-w-0 flex-1">
                ...
                <p class="mt-1 text-sm">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasCharacters && $selectedCharacter): ?>
                        Managing: <span
            ...
            <div class="mt-4 flex items-center gap-4 md:ml-4 md:mt-0">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasCharacters): ?>
                    <!-- Character Selector -->
                    <div class="relative">
                        ...
                        <select id="character-selector"
                            ...
                            aria-label="Select character" data-url="<?php echo e(route('dashboard')); ?>"
                            onchange="window.location.href = this.dataset.url + '?character=' + this.value;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $characters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $character): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="flex items-baseline">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($metrics['nextRace']): ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-fade-in-delay-2">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="glass-card rounded-xl p-6">
                        <?php if (isset($component)) { $__componentOriginal71ea1ae17fa8b33dc40df4eec24154f9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal71ea1ae17fa8b33dc40df4eec24154f9 = $attributes; } ?>
<?php $component = App\View\Components\TurnCounter::resolve(['current' => $metrics['currentTurn'],'total' => $metrics['maxTurns']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('turn-counter'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\TurnCounter::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal71ea1ae17fa8b33dc40df4eec24154f9)): ?>
<?php $attributes = $__attributesOriginal71ea1ae17fa8b33dc40df4eec24154f9; ?>
<?php unset($__attributesOriginal71ea1ae17fa8b33dc40df4eec24154f9); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71ea1ae17fa8b33dc40df4eec24154f9)): ?>
<?php $component = $__componentOriginal71ea1ae17fa8b33dc40df4eec24154f9; ?>
<?php unset($__componentOriginal71ea1ae17fa8b33dc40df4eec24154f9); ?>
<?php endif; ?>
                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.line-chart','data' => ['title' => 'Stat Progression','data' => $statProgression ?? [[100, 150, 200, 280, 350, 420, 480]],'labels' => $progressionLabels ?? [
                        'Turn 5',
                        'Turn 10',
                        'Turn 15',
                        'Turn 20',
                        ...
                        'Turn 28',
                        'Turn 32',
                    ],'colors' => ['#3B82F6', '#10B981', '#F59E0B'],'height' => 'h-72']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Stat Progression','data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($statProgression ?? [[100, 150, 200, 280, 350, 420, 480]]),'labels' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($progressionLabels ?? [
                        'Turn 5',
                        'Turn 10',
                        'Turn 15',
                        'Turn 20',
                        ...
                        'Turn 28',
                        'Turn 32',
                    ]),'colors' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['#3B82F6', '#10B981', '#F59E0B']),'height' => 'h-72']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal70194639c523b094c8b99d35df67f4a7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal70194639c523b094c8b99d35df67f4a7 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.class-pyramid','data' => ['title' => 'Race Grade Distribution','grades' => $raceGrades ?? [
                    ...
                    ],'variant' => 'pyramid']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('class-pyramid'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Race Grade Distribution','grades' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($raceGrades ?? [
                        ['grade' => 'G1', 'fans' => 5000, 'color' => 'bg-red-500'],
                        ['grade' => 'G2', 'fans' => 3500, 'color' => 'bg-orange-500'],
                        ['grade' => 'G3', 'fans' => 2000, 'color' => 'bg-yellow-500'],
                        ['grade' => 'Listed', 'fans' => 1200, 'color' => 'bg-green-500'],
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal70194639c523b094c8b99d35df67f4a7)): ?>
<?php $attributes = $__attributesOriginal70194639c523b094c8b99d35df67f4a7; ?>
<?php unset($__attributesOriginal70194639c523b094c8b99d35df67f4a7); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal70194639c523b094c8b99d35df67f4a7)): ?>
<?php $component = $__componentOriginal70194639c523b094c8b99d35df67f4a7; ?>
<?php unset($__componentOriginal70194639c523b094c8b99d35df67f4a7); ?>
<?php endif; ?>
                </div>

                
                <?php if (isset($component)) { $__componentOriginald8491b0f1a1d14c93b04db3540983f2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald8491b0f1a1d14c93b04db3540983f2c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.activity-timeline','data' => ['title' => 'Recent Activity','events' => $recentActivity ?? [],'variant' => 'timeline','class' => 'mb-6']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('activity-timeline'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Recent Activity','events' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($recentActivity ?? []),'variant' => 'timeline','class' => 'mb-6']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>

<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald8491b0f1a1d14c93b04db3540983f2c)): ?>
<?php $attributes = $__attributesOriginald8491b0f1a1d14c93b04db3540983f2c; ?>
<?php unset($__attributesOriginald8491b0f1a1d14c93b04db3540983f2c); ?>
<?php endif; ?>
<?php if (isset($__componentOriginald8491b0f1a1d14c93b04db3540983f2c)): ?>
<?php $component = $__componentOriginald8491b0f1a1d14c93b04db3540983f2c; ?>
<?php unset($__componentOriginald8491b0f1a1d14c93b04db3540983f2c); ?>
<?php endif; ?>
            </div>
