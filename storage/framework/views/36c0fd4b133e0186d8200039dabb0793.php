...
<?php $component = App\View\Components\Breadcrumb::resolve(['items' => [['label' => 'Characters', 'url' => route('characters.index')], ['label' => 'Create Character']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
    ...
    <div class="lg:ml-60 max-w-5xl mx-auto space-y-6" x-data="characterWizard()">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="mt-4 sm:ml-4 sm:mt-0">
                <a href="<?php echo e(route('characters.index')); ?>" class="btn btn-secondary">
            ...
            <nav aria-label="Progress">
                <ol class="flex items-center justify-between">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <li class="relative <?php echo e($index < count($steps) - 1 ? 'pr-8 sm:pr-20' : ''); ?> flex-1">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($index < count($steps) - 1): ?>
                                <div class="absolute inset-0 flex items-center" aria-hidden="true">
                                    <div class="h-0.5 w-full"
                                        :class="currentStep > <?php echo e($step['id']); ?> ? 'bg-primary-600' :
                                            'bg-gray-200 dark:bg-gray-700'">
                                    </div>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <button type="button" @click="goToStep(<?php echo e($step['id']); ?>)"
                                ...
                                :class="currentStep === <?php echo e($step['id']); ?> ?
                                    'bg-primary-600 ring-4 ring-primary-100 dark:ring-primary-900/30' :
                                    currentStep > <?php echo e($step['id']); ?> ? 'bg-primary-600' :
                                    'bg-gray-200 dark:bg-gray-700'"
                                :aria-current="currentStep === <?php echo e($step['id']); ?> ? 'step' : null">
                                <svg class="w-5 h-5"
                                    :class="currentStep >= <?php echo e($step['id']); ?> ? 'text-white' :
                            ...
                            <span class="absolute top-12 left-1/2 -translate-x-1/2 whitespace-nowrap text-xs font-medium"
                                :class="currentStep === <?php echo e($step['id']); ?> ? 'text-primary-600 dark:text-primary-400' :
                                    'text-gray-500 dark:text-gray-400'">
        ...
        <form method="POST" action="<?php echo e(route('characters.store')); ?>" id="character-form">
            <?php echo csrf_field(); ?>
                ...
                <div class="card-body space-y-6">
                    ...
                    <div x-show="showDatabase" x-transition
                        ...
                        <div class="xl:col-span-2 space-y-4">
                            <?php echo $__env->make('characters.partials.database-search', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </div>
                    ...
                    <!-- Manual Input Fields -->
                    <div class="pt-2">
                        <?php echo $__env->make('characters.partials.basic-info-fields', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
                </div>
            ...
            <section x-show="currentStep === 2" x-transition class="card rounded-xl" role="region"
                ...
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="space-y-2">
                                <div class="flex items-center justify-between">
                                    <label for="stat_<?php echo e($stat); ?>" class="form-label flex items-center gap-2">
                                        <span class="font-semibold"><?php echo e($info['label']); ?></span>
                                        <span class="text-xs text-primary-500"
                                            title="Priority"><?php echo e($info['priority']); ?></span>
                                    </label>
                                    <span class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($info['desc']); ?></span>
                                </div>
                                <div class="relative">
                                    <input type="number" id="stat_<?php echo e($stat); ?>"
                                        name="stats[<?php echo e($stat); ?>]"
                                        x-model.number="formData.stats.<?php echo e($stat); ?>" min="0"
                                        max="1200" step="10" class="form-input pr-16 text-lg font-semibold"
                                        @input="validateStat('<?php echo e($stat); ?>')">
                                    <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                        <span class="text-sm font-medium px-2 py-1 rounded"
                                            :class="getGradeColor(formData.stats.<?php echo e($stat); ?>)"
                                            x-text="getGrade(formData.stats.<?php echo e($stat); ?>)"></span>
                                    </div>
                                </div>
                                <div class="h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                    <div class="h-full bg-<?php echo e($info['color']); ?>-500 transition-all duration-300"
                                        :style="`width: ${(formData.stats.<?php echo e($stat); ?> / 1200) * 100}%`"></div>
                                </div>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['sprint' => 'Sprint (1000-1400m)', 'mile' => 'Mile (1401-1800m)', 'medium' => 'Medium (1801-2400m)', 'long' => 'Long (2401m+)']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <div>
                                        <label class="form-label text-xs font-semibold"><?php echo e($label); ?></label>
                                        <select name="aptitudes[distance][<?php echo e($key); ?>]"
                                            x-model="formData.aptitudes.distance.<?php echo e($key); ?>"
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['turf' => 'Turf', 'dirt' => 'Dirt']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <div>
                                        <label class="form-label text-xs font-semibold"><?php echo e($label); ?></label>
                                        <select name="aptitudes[surface][<?php echo e($key); ?>]"
                                            x-model="formData.aptitudes.surface.<?php echo e($key); ?>"
                                            class="form-select text-sm">
                                            <option value="">Select Grade</option>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                <option value="<?php echo e($grade); ?>"><?php echo e($grade); ?></option>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['front_runner' => 'Front Runner', 'pace_chaser' => 'Pace Chaser', 'late_surger' => 'Late Surger', 'end_closer' => 'End Closer']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <div>
                                        <label class="form-label text-xs font-semibold"><?php echo e($label); ?></label>
                                        <select name="aptitudes[style][<?php echo e($key); ?>]"
                                            x-model="formData.aptitudes.style.<?php echo e($key); ?>"
                                            class="form-select text-sm">
                                            <option value="">Select Grade</option>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                <option value="<?php echo e($grade); ?>"><?php echo e($grade); ?></option>
    ...
    <script>
        ...
        window.pageData = {
            trainees: <?php echo json_encode($trainees ?? [], 15, 512) ?>,
            routes: {
                store: "<?php echo e(route('characters.store')); ?>"
            },
            externalPrefill: <?php echo json_encode($externalPrefill ?? null, 15, 512) ?>
        };
    </script>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/pages/characters/create.js']); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/characters/create.blade.php ENDPATH**/ ?>