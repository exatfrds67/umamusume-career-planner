            ...
            <section x-show="currentStep === 2" x-transition class="card rounded-xl" role="region"
                ...
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="space-y-2">
                ...
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-3">
                                <?php $__currentLoopData = ['sprint' => 'Sprint (1000-1400m)', 'mile' => 'Mile (1401-1800m)', 'medium' => 'Medium (1801-2400m)', 'long' => 'Long (2401m+)']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-3">
                                <?php $__currentLoopData = ['turf' => 'Turf', 'dirt' => 'Dirt']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>
                                        <label class="form-label text-xs font-semibold"><?php echo e($label); ?></label>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-3">
                                <?php $__currentLoopData = ['front_runner' => 'Front Runner', 'pace_chaser' => 'Pace Chaser', 'late_surger' => 'Late Surger', 'end_closer' => 'End Closer']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div>
                                        <label class="form-label text-xs font-semibold"><?php echo e($label); ?></label>
