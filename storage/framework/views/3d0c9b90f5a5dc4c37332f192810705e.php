...
<?php $component = App\View\Components\Breadcrumb::resolve(['items' => [['label' => 'Skills']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
    ...
    <div class="space-y-6" x-data="skillManagement(<?php echo e($isAdmin ? 'true' : 'false'); ?>, '<?php echo e($selectedCharacterId ?? ''); ?>')">
            ...
            <div class="flex items-center gap-3">
                ...
                <select x-model="selectedCharacterId" @change="loadCharacterData()" id="character-selector"
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $characters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $character): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <option value="<?php echo e($character->id); ?>"><?php echo e($character->name); ?></option>
        ...
        <div x-show="character && !loading" class="space-y-6">
            ...
            <div class="mt-6">
                ...
                <div x-show="activeTab === 'inventory'" role="tabpanel" id="panel-inventory"
                    ...
                    <?php echo $__env->make('skills.partials.inventory', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>

                
                <div x-show="activeTab === 'acquisition'" role="tabpanel" id="panel-acquisition"
                    aria-labelledby="tab-acquisition" tabindex="0">
                    <?php echo $__env->make('skills.partials.acquisition', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>

                
                <div x-show="activeTab === 'evolution'" role="tabpanel" id="panel-evolution"
                    aria-labelledby="tab-evolution" tabindex="0">
                    <?php echo $__env->make('skills.partials.evolution', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>

                
                <div x-show="activeTab === 'planner'" role="tabpanel" id="panel-planner" aria-labelledby="tab-planner"
                    tabindex="0">
                    <?php echo $__env->make('skills.partials.planner', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>

                
                <div x-show="activeTab === 'performance'" role="tabpanel" id="panel-performance"
                    aria-labelledby="tab-performance" tabindex="0">
                    <?php echo $__env->make('skills.partials.performance', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            </div>
        </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        window.skillsData = {
            isAdmin: <?php echo json_encode($isAdmin ?? false, 15, 512) ?>,
            preSelectedCharacterId: '<?php echo e($preSelectedCharacterId ?? ''); ?>'
        };
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/skills/index.blade.php ENDPATH**/ ?>