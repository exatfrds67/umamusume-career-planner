...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.toggle','data' => ['name' => 'notifications','label' => 'Notifications','hint' => 'Receive email updates']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'notifications','label' => 'Notifications','hint' => 'Receive email updates']); ?>
...
<?php endif; ?><?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\storage\framework\views/2acad34fae307ef62d638df7dd534c3c.blade.php ENDPATH**/ ?>