...
<div <?php echo e($attributes->merge(['class' => 'performance-dashboard'])); ?> role="region" aria-label="Performance Dashboard">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <?php if($showTrend && isset($trend['trend'])): ?>
            <div class="flex items-center gap-2 px-4 py-2 rounded-lg bg-gray-100 dark:bg-gray-800">
                ...
                <span class="<?php echo e($trendColor); ?> flex items-center gap-1">
                    ...
                    <?php if(isset($trend['improvement_rate']) && $trend['improvement_rate'] != 0): ?>
                        <span
...
<?php endif; ?>
    ...
    <?php if(isset($metrics['metrics_by_scenario']) && !empty($metrics['metrics_by_scenario'])): ?>
        <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">
                Performance by Scenario
            </h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <?php $__currentLoopData = $metrics['metrics_by_scenario']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scenario => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if(isset($trend['recent_performance']) && !empty($trend['recent_performance'])): ?>
        <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">
                Recent Performance
            </h3>
            <div class="flex items-end gap-2 h-24">
                <?php $__currentLoopData = $trend['recent_performance']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $perf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
