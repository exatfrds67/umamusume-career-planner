...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.select-dropdown','data' => ['name' => 'grade','placeholder' => 'Choose a grade','options' => ['S' => 'S Rank']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'grade','placeholder' => 'Choose a grade','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['S' => 'S Rank'])]); ?>
...
<?php endif; ?>
        <?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\storage\framework\views/6fcc402ca8d9d8193be2aef8573644a8.blade.php ENDPATH**/ ?>