...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.analytics.trend-analysis-chart','data' => ['data' => $data,'metric' => 'efficiency']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($data),'metric' => 'efficiency']); ?>
...
<?php endif; ?><?php /**PATH C:\Users\exatf\AppData\Local\Temp/larC5CB.blade.php ENDPATH**/ ?>