        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <select name="preferences[theme]" id="theme"
                    ...
                    <option value="light"
                        <?php echo e(old('preferences.theme', $user->preferences['theme'] ?? 'auto') === 'light' ? 'selected' : ''); ?>>
                        Light</option>
                    <option value="dark"
                        <?php echo e(old('preferences.theme', $user->preferences['theme'] ?? 'auto') === 'dark' ? 'selected' : ''); ?>>
                        Dark</option>
                    <option value="auto"
                        <?php echo e(old('preferences.theme', $user->preferences['theme'] ?? 'auto') === 'auto' ? 'selected' : ''); ?>>
                        Auto (System)</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="preferences[language]" id="language"
                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
                    <option value="en"
                        <?php echo e(old('preferences.language', $user->preferences['language'] ?? 'en') === 'en' ? 'selected' : ''); ?>>
                        English</option>
                    <option value="ja"
                        <?php echo e(old('preferences.language', $user->preferences['language'] ?? 'en') === 'ja' ? 'selected' : ''); ?>>
                        日本語 (Japanese)</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="preferences[timezone]" id="timezone"
                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
                    <option value="UTC"
                        <?php echo e(old('preferences.timezone', $user->preferences['timezone'] ?? 'UTC') === 'UTC' ? 'selected' : ''); ?>>
                        UTC</option>
                    <option value="America/New_York"
                        <?php echo e(old('preferences.timezone', $user->preferences['timezone'] ?? 'UTC') === 'America/New_York' ? 'selected' : ''); ?>>
                        Eastern Time (US & Canada)</option>
                    <option value="America/Chicago"
                        <?php echo e(old('preferences.timezone', $user->preferences['timezone'] ?? 'UTC') === 'America/Chicago' ? 'selected' : ''); ?>>
                        Central Time (US & Canada)</option>
                    <option value="America/Denver"
                        <?php echo e(old('preferences.timezone', $user->preferences['timezone'] ?? 'UTC') === 'America/Denver' ? 'selected' : ''); ?>>
                        Mountain Time (US & Canada)</option>
                    <option value="America/Los_Angeles"
                        <?php echo e(old('preferences.timezone', $user->preferences['timezone'] ?? 'UTC') === 'America/Los_Angeles' ? 'selected' : ''); ?>>
                        Pacific Time (US & Canada)</option>
                    <option value="Asia/Tokyo"
                        <?php echo e(old('preferences.timezone', $user->preferences['timezone'] ?? 'UTC') === 'Asia/Tokyo' ? 'selected' : ''); ?>>
                        Tokyo</option>
                    <option value="Europe/London"
                        <?php echo e(old('preferences.timezone', $user->preferences['timezone'] ?? 'UTC') === 'Europe/London' ? 'selected' : ''); ?>>
                        London</option>
                    <option value="Europe/Paris"
                        <?php echo e(old('preferences.timezone', $user->preferences['timezone'] ?? 'UTC') === 'Europe/Paris' ? 'selected' : ''); ?>>
                        Paris</option>
                    <option value="Australia/Sydney"
                        <?php echo e(old('preferences.timezone', $user->preferences['timezone'] ?? 'UTC') === 'Australia/Sydney' ? 'selected' : ''); ?>>
                        Sydney</option>
                </select>
            </div>
            ...
            <div>
                ...
                <select name="preferences[time_format]" id="time_format"
                    class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm">
                    <option value="12h"
                        <?php echo e(old('preferences.time_format', $user->preferences['time_format'] ?? '12h') === '12h' ? 'selected' : ''); ?>>
                        12-hour (2:30 PM)</option>
                    <option value="24h"
                        <?php echo e(old('preferences.time_format', $user->preferences['time_format'] ?? '12h') === '24h' ? 'selected' : ''); ?>>
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <input type="checkbox" name="accessibility_settings[high_contrast]" id="high_contrast"
                            value="1"
                            <?php echo e(old('accessibility_settings.high_contrast', $user->accessibility_settings['high_contrast'] ?? false) ? 'checked' : ''); ?>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <input type="checkbox" name="accessibility_settings[large_text]" id="large_text" value="1"
                            <?php echo e(old('accessibility_settings.large_text', $user->accessibility_settings['large_text'] ?? false) ? 'checked' : ''); ?>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <input type="checkbox" name="accessibility_settings[reduce_motion]" id="reduce_motion"
                            value="1"
                            <?php echo e(old('accessibility_settings.reduce_motion', $user->accessibility_settings['reduce_motion'] ?? false) ? 'checked' : ''); ?>
...
<?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/profile/partials/preferences-tab-content.blade.php ENDPATH**/ ?>