        ...
        <div class="flex items-center gap-6 flex-wrap">
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="flex items-center gap-2">
                    <div class="w-24 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                        ...
                        ?>
                        <div class="h-full transition-all duration-300 <?php echo e($energyColor); ?>"
                            style="width: <?php echo e($character->energy_level); ?>%"></div>
                    </div>
                    <span
                        class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e($character->energy_level); ?>/100</span>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm font-semibold text-gray-900 dark:text-white capitalize flex items-center gap-1">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($character->mood_status):
                        case ('great'): ?>
                        ...
                        <?php default: ?>
                            <span class="text-gray-500">😐</span> <?php echo e($character->mood_status); ?>
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm font-semibold text-gray-900 dark:text-white">
                    <?php echo e($character->current_turn ?? 1); ?>/78
                </span>
            </div>
            ...
            <div class="flex items-center gap-2">
                ...
                ?>
                <span class="text-sm font-semibold <?php echo e($failColor); ?>"><?php echo e($baseFailRate); ?>%</span>
            </div>
        </div>

        
        <div
            class="px-3 py-1 rounded-full text-xs font-medium <?php echo e($character->scenario_type === 'unity_cup' ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300' : 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300'); ?>">
            <?php echo e(str_replace('_', ' ', ucwords($character->scenario_type))); ?>

        </div>
    </div>
</section>
<?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/training/partials/status-bar.blade.php ENDPATH**/ ?>