...
<div id="training-predictions-app" data-character-id="<?php echo e($character->id); ?>"
    data-scenario-type="<?php echo e($character->scenario_type); ?>" data-api-url="<?php echo e(route('api.training-predictions.batch')); ?>"
    ...
    <div id="predictions-grid" class="hidden">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['speed', 'stamina', 'power', 'guts', 'wit', 'rest']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <?php $config = $facilityConfig[$facility]; ?>
                <div class="card rounded-xl p-5 training-facility hover:shadow-lg transition-shadow cursor-pointer"
                    data-facility="<?php echo e($facility); ?>" data-testid="prediction-card-<?php echo e($facility); ?>" role="article"
                    tabindex="0" onclick="selectFacility('<?php echo e($facility); ?>')"
                    onkeydown="if(event.key==='Enter')selectFacility('<?php echo e($facility); ?>')">

                    
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-lg <?php echo e($config['bgLight']); ?> flex items-center justify-center">
                                <svg class="w-6 h-6 <?php echo e($config['textColor']); ?>" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900 dark:text-white capitalize"><?php echo e($facility); ?>

                                </h3>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($facility !== 'rest'): ?>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="ai-badge hidden px-2 py-1 rounded text-xs font-medium bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300"
                            ...
                            <span
                                ...
                                data-testid="risk-badge-<?php echo e($facility); ?>">
                                --
                            </span>
                        </div>
                    </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($facility !== 'rest'): ?>
                        ...
                        <div class="facility-stats space-y-2 text-sm mb-4" data-testid="stat-gains">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="stat-gain font-semibold <?php echo e($config['textColor']); ?>">+--</span>
                            </div>
                            <div class="flex justify-between items-center">
                        ...
                        <div
                            ...
                            <div class="efficiency-rating flex items-center gap-1">
                                <span class="efficiency-stars text-yellow-500">☆☆☆☆☆</span>
                    ...
                    <button
                        ...
                        <?php echo e($facility === 'rest' ? 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600' : 'bg-primary-100 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 hover:bg-primary-200 dark:hover:bg-primary-800'); ?>"
                        onclick="event.stopPropagation(); selectTraining('<?php echo e($facility); ?>')">
                        <?php echo e($facility === 'rest' ? 'Rest' : 'Train'); ?>
...
<?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/training/partials/predictions-grid.blade.php ENDPATH**/ ?>