...
<div id="training-predictions-app" data-character-id="<?php echo e($character->id); ?>"
    ...
    <div id="predictions-grid" class="hidden">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <?php $__currentLoopData = ['speed', 'stamina', 'power', 'guts', 'wit', 'rest']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facility): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
