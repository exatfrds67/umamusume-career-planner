...
<div class="space-y-6">
    ...
    <div>
        ...
        <select id="training_type" name="training_type"
            ...
            <?php $__currentLoopData = ['speed' => 'Speed', 'stamina' => 'Stamina', 'power' => 'Power', 'guts' => 'Guts', 'wit' => 'Wit', 'rest' => 'Rest', 'infirmary' => 'Infirmary', 'outing' => 'Outing']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
