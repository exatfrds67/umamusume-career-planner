...
<?php $__env->startSection('content'); ?>
    <main class="space-y-6">
        ...
        <header class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                <nav aria-label="Breadcrumb">
                    <a href="<?php echo e(route('races.index')); ?>" class="btn btn-secondary btn-sm">
        ...
        <section class="card bg-white dark:bg-gray-800 overflow-hidden" aria-labelledby="race-info-title">
            ...
            <div class="md:flex">
                <div class="p-8 md:w-1/2 bg-linear-to-br from-primary-600 to-primary-800 text-white flex flex-col justify-center">
                    ...
                    <?php if($race->race_conditions): ?>
                        <div class="mt-6">
                            <h3 class="text-sm font-bold text-primary-200 uppercase">Conditions</h3>
                            <ul class="mt-2 space-y-1 text-sm">
                                <?php $__currentLoopData = $race->race_conditions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $condition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <?php if($race->preparation_strategy): ?>
                <section class="card bg-white dark:bg-gray-800 h-full" aria-labelledby="prep-strategy-title">
                    ...
                    <div class="card-body">
                        <ul class="list-disc list-inside space-y-2 text-sm text-gray-700 dark:text-gray-300">
                            <?php $__currentLoopData = $race->preparation_strategy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $strat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($race->performance_analysis): ?>
                 <section class="card bg-white dark:bg-gray-800 h-full" aria-labelledby="perf-analysis-title">
                    ...
                    <div class="card-body">
                         <div class="prose dark:prose-invert text-sm">
                             <?php if(is_array($race->performance_analysis)): ?>
                                <ul class="list-disc list-inside">
                                    <?php $__currentLoopData = $race->performance_analysis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $analysis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
