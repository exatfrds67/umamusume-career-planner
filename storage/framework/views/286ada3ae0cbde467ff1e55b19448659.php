...
<?php $__env->startSection('content'); ?>
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-6xl mx-auto">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($extraction): ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($extraction->confidence_score < 0.7): ?>
                ...
                <div
                    ...
                    <div class="flex justify-center">
                        <img src="<?php echo e(Storage::url($extraction->image_path)); ?>" alt="Uploaded screenshot" loading="lazy"
                            decoding="async"
                ...
                <form id="correction-form" method="POST" action="<?php echo e(route('ocr.import', $extraction->id)); ?>">
                    ...
                    <div
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($extraction->data_type === 'character_stats'): ?>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/pages/ocr/results.js']); ?>
