<div class="bg-white dark:bg-gray-800 shadow rounded-lg">
    <div class="px-4 py-5 sm:p-6">
        ...
        <form action="<?php echo e(route('profile.password.change')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">
                            <?php echo e(request()->userAgent()); ?> • Last active: Now
                        </p>
                    </div>
                </div>
                <span
...
<div class="mt-6 bg-red-50 dark:bg-red-900/20 border-2 border-red-200 dark:border-red-800 rounded-lg"
    ...
    <div x-show="show" x-cloak @click.away="closeModal()" @keydown.escape.window="closeModal()"
        ...
        <div @click.stop class="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full p-6 shadow-xl">
            ...
            <form action="<?php echo e(route('profile.destroy')); ?>" method="POST" class="space-y-4" @submit="handleSubmit">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    <label for="delete_confirmation"
                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Type <strong class="text-red-600 dark:text-red-400"><?php echo e($user?->name ?? 'your username'); ?></strong> to confirm
                    </label>
                    <input type="text" name="confirmation" id="delete_confirmation" required x-model="confirmation"
                        placeholder="<?php echo e($user?->name ?? 'your username'); ?>"
                        class="block w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
                    ...
                    <p x-show="confirmationError" x-cloak class="mt-1 text-sm text-red-600 dark:text-red-400">
                        Account name does not match. Please type <strong><?php echo e($user?->name ?? 'your username'); ?></strong> exactly.
                    </p>
                </div>
...
<?php if (! $__env->hasRenderedOnce('afe86d81-8700-4428-b58a-ef2967008c13')): $__env->markAsRenderedOnce('afe86d81-8700-4428-b58a-ef2967008c13'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/pages/profile/partials/security-tab.js']); ?>
<?php endif; ?>
<?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/profile/partials/security-tab.blade.php ENDPATH**/ ?>