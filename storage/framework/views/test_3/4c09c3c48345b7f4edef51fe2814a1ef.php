...
<div class="space-y-6">
    ...
    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
        ...
        <div class="grid grid-cols-3 gap-4">
            <?php $__currentLoopData = $exportFormats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $format): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <?php $__currentLoopData = array_slice($exportTemplates, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
