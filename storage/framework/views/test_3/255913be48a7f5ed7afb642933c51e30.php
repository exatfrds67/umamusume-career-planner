    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
            ...
            <select id="surface" name="surface"
                ...
                <?php $__currentLoopData = ['turf' => 'Turf', 'dirt' => 'Dirt']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div>
            ...
            <select id="distance_category" name="distance_category"
                ...
                <?php $__currentLoopData = ['sprint' => 'Sprint', 'mile' => 'Mile', 'medium' => 'Medium', 'long' => 'Long']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <select id="outcome" name="outcome"
                ...
                <?php $__currentLoopData = ['victory' => 'Victory (1st)', 'podium' => 'Podium (2nd-3rd)', 'top_5' => 'Top 5', 'defeat' => 'Defeat']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
