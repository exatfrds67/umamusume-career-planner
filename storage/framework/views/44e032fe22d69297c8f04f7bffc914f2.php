<?php $__env->startSection('content'); ?>
    ...
    <script>
        window.deckBuilderData = {
            deck: <?php echo json_encode($deckData, 15, 512) ?>,
            availableCards: <?php echo json_encode($availableCardsData, 15, 512) ?>,
            characterId: <?php echo e($character->id); ?>

        };
    </script>

    
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/app.js', 'resources/js/pages/support-cards/deck-builder.js']); ?>
