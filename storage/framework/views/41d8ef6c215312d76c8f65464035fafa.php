<?php $__env->startSection('title', 'Welcome - Umamusume Career Planner'); ?>
                    ...
                    <div class="glass-card rounded-2xl p-6 sm:p-8 transition-all duration-300 animate-fade-in h-full">
                        ...
                        <div class="text-center mb-6">
                            <img src="/images/app_logo/uma_musume_race_planner_logo_256.png"
                                alt="<?php echo e(config('app.name', 'Umamusume Career Planner')); ?> logo"
                        ...
                        <div
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(app()->environment('local', 'development')): ?>
                                <a href="<?php echo e(route('dev.demos')); ?>"
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/welcome.blade.php ENDPATH**/ ?>