    ...
    function profileManager() {
        return {
            ...
            profile: {
                ...
                preferences: <?php echo json_encode(
                    $user->preferences ?? [
                        'theme' => 'auto',
                        'language' => 'en',
                        'timezone' => 'UTC',
                ...
                async changePassword() {
                    ...
                    try {
                        const response = await fetch('<?php echo e(route('profile.password.change')); ?>', {
                            method: 'PUT',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
                ...
                resetForm() {
                    ...
                    this.preferences = <?php echo json_encode(
                        $user->preferences ?? [
                            'theme' => 'auto',
                            'language' => 'en',
                            'timezone' => 'UTC',
                ...
                async exportData() {
                    ...
                    try {
                        const response = await fetch('<?php echo e(route('profile.export')); ?>', {
                            method: 'GET',
                            headers: {
                                'Accept': 'application/json',
                                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
