...
>
    <div class="flex items-start gap-3">
        ...
        <div class="shrink-0">
            <svg class="h-5 w-5 <?php echo e($config['icon']); ?>" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                <?php echo $icon; ?>
        ...
        <div class="flex-1 min-w-0">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($title): ?>
                <h3 class="text-sm font-semibold <?php echo e($config['title']); ?>">
                    <?php echo e($title); ?>

                </h3>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <div class="text-sm <?php echo e($config['text']); ?> <?php echo e($title ? 'mt-1' : ''); ?>">
                <?php echo e($slot); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($dismissible): ?>
            <div class="shrink-0">
                <button
                    type="button"
                    @click="show = false"
                    class="inline-flex rounded-md p-1.5 <?php echo e($config['button']); ?> focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors"
...
<?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/components/alert-banner.blade.php ENDPATH**/ ?>