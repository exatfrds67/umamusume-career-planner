...
<div <?php echo e($attributes->merge(['class' => 'operation-history'])); ?>>
    ...
    <?php else: ?>
            ...
            <?php $__currentLoopData = $operations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $operation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div
                    ...
                    <div class="text-right">
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            <?php if(isset($operation['completed_at'])): ?>
        ...
        <?php if($showPagination && $pagination && $pagination['total_pages'] > 1): ?>
