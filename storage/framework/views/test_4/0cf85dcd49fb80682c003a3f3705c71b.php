...
<?php $__env->startSection('content'); ?>
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section class="card rounded-xl p-6 mb-6 animate-fade-in-delay-1" aria-labelledby="selection-heading">
            ...
            <form method="GET" action="<?php echo e(route('training.predictions')); ?>" class="space-y-4">
                <div>
        ...
        <?php if($selectedCharacter): ?>
            ...
            <section class="card rounded-xl p-6 mb-6 animate-fade-in-delay-2" aria-labelledby="char-overview-heading">
                <h2 id="char-overview-heading" class="text-xl font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">
                    <?php echo e($selectedCharacter->name); ?>
                        ...
                        <div class="space-y-2">
                            <?php $__currentLoopData = ['speed', 'stamina', 'power', 'guts', 'wit']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex justify-between items-center">
                                    <span
                                        class="text-sm text-gray-700 dark:text-gray-300 capitalize transition-colors duration-300"><?php echo e($stat); ?></span>
                                    <span
                                        class="text-sm font-semibold text-gray-900 dark:text-white transition-colors duration-300">
                                        <?php echo e($selectedCharacter->current_stats[$stat] ?? 0); ?>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700 rounded-lg p-4">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between items-center">
                                ...
                                <span
                                    class="text-sm font-semibold text-gray-900 dark:text-white transition-colors duration-300">
                                    <?php echo e($selectedCharacter->energy_level); ?>%
                                </span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span
                                ...
                                <span
                                    ...
                                    <?php echo e($selectedCharacter->mood_status); ?>
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span
                                    class="text-sm font-semibold text-gray-900 dark:text-white capitalize transition-colors duration-300">
                                    <?php echo e(str_replace('_', ' ', $selectedCharacter->scenario_type)); ?>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700 rounded-lg p-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-gray-700 dark:text-gray-300 transition-colors duration-300">
                                <?php echo e($selectedCharacter->supportCards->count()); ?> cards equipped
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div id="training-predictions-app" 
                data-character-id="<?php echo e($selectedCharacter->id); ?>"
                data-scenario-type="<?php echo e($selectedCharacter->scenario_type); ?>"
