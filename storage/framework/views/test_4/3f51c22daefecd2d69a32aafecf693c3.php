...
<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            ?>
            <?php $__currentLoopData = $factorCounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $starLevel => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <?php $__errorArgs = ['source_character_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="lg:col-span-2">
                <div class="glass-card-alt rounded-lg">
                    ...
                    <div class="card-body">
                        <?php if(array_sum($factorCounts) > 0): ?>
                            <?php
                                $factorTypeLabels = [
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex items-center gap-3">
                                                            ...
                                                            <div>
                                                                ...
                                                                <?php if($factor->source_character_name): ?>
