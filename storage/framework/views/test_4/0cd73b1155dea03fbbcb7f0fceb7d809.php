...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['workflow' => null]));
...
foreach (array_filter((['workflow' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/components/ai/workflow-visualization.blade.php ENDPATH**/ ?>