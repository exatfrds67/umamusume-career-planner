...
<div x-data="trendAnalysisChart({
    ...
    metric: '<?php echo e($metric); ?>',
    config: <?php echo e(json_encode($config)); ?>,
    showConfidence: <?php echo e($showConfidence ? 'true' : 'false'); ?>,
    showPrediction: <?php echo e($showPrediction ? 'true' : 'false'); ?>

})"
    <?php echo e($attributes->merge(['class' => 'trend-analysis-chart glass-card-inner rounded-lg p-4'])); ?> role="figure"
    aria-label="Trend analysis chart showing <?php echo e($config['label']); ?> over time with confidence intervals">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
        <div>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">
                <?php echo e($config['label']); ?> trend with statistical analysis
            </p>
        </div>

        
        <div class="flex items-center gap-3">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showConfidence): ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showPrediction): ?>
                <label class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 cursor-pointer">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
        <div class="text-center">
            ...
            <p class="text-lg font-bold text-gray-900 dark:text-white"
                x-text="stats.current + '<?php echo e($config['unit']); ?>'"></p>
        </div>
        <div class="text-center">
            <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide">Average</p>
            <p class="text-lg font-bold text-gray-900 dark:text-white"
                x-text="stats.average + '<?php echo e($config['unit']); ?>'"></p>
        </div>
        <div class="text-center">
            ...
            <p class="text-lg font-bold"
                ...
                <span x-text="Math.abs(stats.trendValue) + '<?php echo e($config['unit']); ?>'"></span>
            </p>
        </div>
        <div class="text-center">
    ...
    <div class="relative" style="height: <?php echo e($height); ?>;">
        <canvas id="<?php echo e($chartId); ?>" role="img"
            aria-label="Line chart showing <?php echo e($config['label']); ?> trend over time"></canvas>
    ...
    <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
        <div class="flex flex-wrap items-center gap-4 text-xs text-gray-600 dark:text-gray-400">
            <div class="flex items-center gap-2">
                <span class="w-4 h-0.5" style="background-color: <?php echo e($config['color']); ?>;"></span>
                <span>Actual <?php echo e($config['label']); ?></span>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showConfidence): ?>
                <div class="flex items-center gap-2" x-show="displayConfidence">
                    <span class="w-4 h-3 rounded opacity-30" style="background-color: <?php echo e($config['color']); ?>;"></span>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showPrediction): ?>
                <div class="flex items-center gap-2" x-show="displayPrediction">
                    <span class="w-4 h-0.5 border-t-2 border-dashed"
                        style="border-color: <?php echo e($config['color']); ?>;"></span>
    ...
    <div class="sr-only">
        <table>
            <caption><?php echo e($config['label']); ?> trend data</caption>
            <thead>
                <tr>
                    <th>Period</th>
                    <th>Value</th>
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                    <tr>
                        <td><?php echo e($point['label'] ?? 'N/A'); ?></td>
                        <td><?php echo e($point['value'] ?? 0); ?><?php echo e($config['unit']); ?></td>
                        <td><?php echo e($point['lower'] ?? 0); ?><?php echo e($config['unit']); ?></td>
                        <td><?php echo e($point['upper'] ?? 0); ?><?php echo e($config['unit']); ?></td>
                    </tr>
...
<?php if (! $__env->hasRenderedOnce('fb8487b2-2ab3-49cb-888e-7e0229c8def9')): $__env->markAsRenderedOnce('fb8487b2-2ab3-49cb-888e-7e0229c8def9');
...
<?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/components/analytics/trend-analysis-chart.blade.php ENDPATH**/ ?>