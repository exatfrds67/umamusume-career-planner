...
<div class="space-y-6">
    ...
    <div>
        ...
        <select id="training_type" name="training_type"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['speed' => 'Speed', 'stamina' => 'Stamina', 'power' => 'Power', 'guts' => 'Guts', 'wit' => 'Wit', 'rest' => 'Rest', 'infirmary' => 'Infirmary', 'outing' => 'Outing']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <option value="<?php echo e($value); ?>" <?php echo e(($data['training_type'] ?? '') === $value ? 'selected' : ''); ?>>
                    <?php echo e($label); ?>
    ...
    <div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['speed' => 'Speed', 'stamina' => 'Stamina', 'power' => 'Power', 'guts' => 'Guts', 'wit' => 'Wit']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <div>
                    <label for="stat_gain_<?php echo e($stat); ?>"
                        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        <?php echo e($label); ?>

                    </label>
                    <input type="number" id="stat_gain_<?php echo e($stat); ?>" name="stat_gains[<?php echo e($stat); ?>]"
                        value="<?php echo e($data['stat_gains'][$stat] ?? 0); ?>" min="0" max="200"
                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
                        placeholder="0" aria-label="<?php echo e($label); ?> stat gain">
                </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="number" id="energy_cost" name="energy_cost" value="<?php echo e($data['energy_cost'] ?? ''); ?>"
                min="0" max="100"
                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
        ...
        <div>
            ...
            <input type="number" id="turn_number" name="turn_number" value="<?php echo e($data['turn_number'] ?? ''); ?>"
                min="1" max="78"
                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
        ...
        <div class="space-y-2">
            <label class="flex items-center">
                <input type="checkbox" name="has_skill_hint" value="1"
                    <?php echo e($data['has_skill_hint'] ?? false ? 'checked' : ''); ?>
            ...
            <label class="flex items-center">
                <input type="checkbox" name="has_friendship" value="1"
                    <?php echo e($data['has_friendship'] ?? false ? 'checked' : ''); ?>
            ...
            <label class="flex items-center">
                <input type="checkbox" name="has_spirit_burst" value="1"
                    <?php echo e($data['has_spirit_burst'] ?? false ? 'checked' : ''); ?>
    ...
    <div>
        ...
        <input type="text" id="participants" name="participants"
            value="<?php echo e(is_array($data['participants'] ?? null) ? implode(', ', $data['participants']) : $data['participants'] ?? ''); ?>"
            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white"
...
<?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/ocr/partials/training-session-form.blade.php ENDPATH**/ ?>