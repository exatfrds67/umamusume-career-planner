...
<?php $component = App\View\Components\Breadcrumb::resolve(['items' => [['label' => 'Characters']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        window.charactersData = <?php echo json_encode($characters, 15, 512) ?>;
    </script>
<?php $__env->stopPush(); ?>
