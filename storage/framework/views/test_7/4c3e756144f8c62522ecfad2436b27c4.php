...
<div class="space-y-6">
    ...
    <div>
        ...
        <div id="skills-container" class="space-y-3">
            <?php $__empty_1 = true; $__currentLoopData = $data['skills'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div
...
<?php $__env->startPush('scripts'); ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            let skillIndex = <?php echo e(count($data['skills'] ?? [])); ?>;
