                ...
                <div class="flex flex-col md:flex-row gap-8 items-start relative">
                    ...
                    <div class="shrink-0 relative">
                        ...
                        <?php else: ?>
                            ...
                            ?>
                            <div class="w-32 h-32 md:w-40 md:h-40 rounded-full border-4 border-white dark:border-gray-800 shadow-xl bg-cover bg-center bg-linear-to-br <?php echo e($avatarClass); ?>"
                                aria-label="<?php echo e($character->name); ?> avatar" role="img">
                            </div>
                        <?php endif; ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <section class="card rounded-lg" role="region" aria-labelledby="stats-heading">
                    ...
                    <div class="card-body">
                        <div class="space-y-6">
                            <?php $__currentLoopData = ['speed' => 'blue', 'stamina' => 'orange', 'power' => 'red', 'guts' => 'pink', 'wit' => 'green']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="group">
                                    <div class="flex items-end justify-between mb-2">
                                        <div class="flex items-center gap-2">
                                            <span
                                                class="w-16 text-sm font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400"><?php echo e(ucfirst($stat)); ?></span>
                                            <?php if (isset($component)) { $__componentOriginal38ed160b843d185cc0ee7da813217a54 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal38ed160b843d185cc0ee7da813217a54 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.grade-badge','data' => ['grade' => $character->getStatGrade($val),'size' => 'sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.grade-badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['grade' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($character->getStatGrade($val)),'size' => 'sm']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal38ed160b843d185cc0ee7da813217a54)): ?>
<?php $attributes = $__attributesOriginal38ed160b843d185cc0ee7da813217a54; ?>
...
<?php endif; ?>
                                            <span
                                                class="text-2xl font-bold text-gray-900 dark:text-white tabular-nums"><?php echo e($val); ?></span>
                                        </div>
                                        <?php if($target > 0): ?>
                                            <div class="text-xs text-gray-400">Target: <span
                                                    class="font-medium text-gray-600 dark:text-gray-300"><?php echo e($target); ?></span>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="relative h-3 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                                        ...
                                        <?php if($target > 0): ?>
                                            <div class="absolute top-0 bottom-0 w-0.5 bg-gray-400 dark:bg-gray-500 z-10"
                                                style="<?php echo \Illuminate\Support\Arr::toCssStyles(['left' => $targetPercentage . '%']) ?>"></div>
                                        <?php endif; ?>

                                        <!-- Fill -->
                                        <div class="absolute top-0 left-0 bottom-0 rounded-full transition-all duration-500 ease-out stat-bar-<?php echo e($stat); ?>"
                                            style="<?php echo \Illuminate\Support\Arr::toCssStyles(['width' => $percentage . '%']) ?>"></div>
                                    </div>
                                </div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    <?php $__currentLoopData = $upcomingRaces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $race): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                            <td class="px-4 py-3 text-sm font-medium text-gray-900 dark:text-white">
                                                <?php echo e($raceName); ?></td>
                                            <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">
                                                <?php echo e($raceGrade); ?></td>
                                            <td class="px-4 py-3 text-sm text-gray-500 dark:text-gray-400">Turn
                                                <?php echo e($raceTurn); ?></td>
                                            <td class="px-4 py-3">
                                                <span
                                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($readinessColor); ?>">
            ...
            <div class="space-y-6">
                ...
                <section class="card rounded-lg" role="region" aria-labelledby="aptitudes-heading">
                    ...
                    <div class="card-body space-y-6">
                        ...
                        <?php $__currentLoopData = $aptitudeGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $aptitudes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($aptitudes->count() > 0): ?>
                                <div>
                                    <h4 class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">
                                        <?php echo e($groupName); ?></h4>
                                    <div class="grid grid-cols-2 gap-2">
                                        <?php $__currentLoopData = $aptitudes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aptitude): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                $name =
                                            ...
                                            <div
                                                ...
                                                <span class="text-sm dark:text-gray-300"><?php echo e($name); ?></span>
                                                <span
                                                    class="font-bold text-gray-900 dark:text-white"><?php echo e($aptitude->grade); ?></span>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                        ...
                        <?php if($character->aptitudes->isEmpty()): ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <section class="card rounded-lg" role="region" aria-labelledby="skills-heading">
                ...
                <div class="p-2">
                    <?php if($character->skills->count() > 0): ?>
                        <div class="space-y-1">
                            <?php $__currentLoopData = $character->skills->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div
                                    ...
                                    <?php if($skill->pivot && $skill->pivot->final_sp_cost): ?>
                                        <span
            ...
            <section class="card rounded-lg" role="region" aria-labelledby="support-deck-heading">
                <header
                    ...
                    <a href="<?php echo e(route('characters.deck-builder', $character)); ?>" class="btn btn-sm btn-primary" aria-label="Manage Support Deck">
                ...
                <div class="card-body">
                    <?php if($character->supportCards->count() > 0): ?>
                        <div class="space-y-3">
                            <?php $__currentLoopData = $character->supportCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supportCard): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
            ...
            <section class="card rounded-lg" role="region" aria-labelledby="inherited-factors-heading">
                ...
                <div class="card-body">
                    <?php if($character->factors->count() > 0): ?>
                        <?php
                        ...
                        <div class="space-y-4">
                            <?php $__currentLoopData = $factorsByType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $factors): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div>
                                    <h4
                                    ...
                                    <div class="space-y-2">
                                        <?php $__currentLoopData = $factors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $factor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div
                                                ...
                                                <div class="flex items-center gap-2">
                                                    <!-- Factor Value/Bonus -->
                                                    <?php if($factor->factor_type === 'blue_stats'): ?>
                        ...
                        <?php if($activeFactors->count() > 0): ?>
                            <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <div class="grid grid-cols-2 gap-2 text-xs">
                                    ...
                                    <?php endif; ?>
                                    <?php if($totalAptitudeUpgrades > 0): ?>
