...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['selectedAgent' => null]));
...
foreach (array_filter((['selectedAgent' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php if (! $__env->hasRenderedOnce('6352cafe-3f5f-4313-87ef-cf430308e23e')): $__env->markAsRenderedOnce('6352cafe-3f5f-4313-87ef-cf430308e23e'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/components/ai/agent-selector.js']); ?>
<?php endif; ?>
<?php /**PATH C:\XAMPP\htdocs\umamusume-career-planner\resources\views/components/ai/agent-selector.blade.php ENDPATH**/ ?>