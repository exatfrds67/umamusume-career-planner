...
class UcpSkillsSeeder extends Seeder
{
    ...
    private function upsertSkill(array $skillData, bool $preserveCuratedMetadata = false): string
    {
        ...
        Skill::create([
            ...
            'character_exclusive' => $skillData['character_exclusive'] ?? null,
            'unique_skill_max_level' => $skillData['unique_skill_max_level'] ?? null,
            'unique_star_upgrade' => $skillData['unique_star_upgrade'] ?? null,
            'unique_star6_initial_level' => $skillData['unique_star6_initial_level'] ?? null,
            'unique_base_effects' => $skillData['unique_base_effects'] ?? null,
            'condition_marker' => $skillData['condition_marker'] ?? null,
