...
│ │            │                                                   │  │
│ │ Dashboard  │ ┌──────────────────────────────────────────────┐ │  │
│ │ Character  │ │ SP Balance Widget                             │ │  │
│ │ Training   │ │ ┌────────────────────────────────────────────┐│ │  │
│ │ Races      │ │ │ Current SP: 450                            ││ │  │
│ │ Skills   ●│ │ │ Total Earned: 2,400 | Spent: 1,950         ││ │  │
│ │ Support    │ │ │ Planned SP: 240 (2 skills pending)         ││ │  │
│ │ AI Advisor │ │ │                                            ││ │  │
│ │ Settings   │ │ │ Budget Status: 🟢 Healthy                  ││ │  │
│ │            │ │ └────────────────────────────────────────────┘│ │  │
│ │            │ └──────────────────────────────────────────────┘ │  │
│ │            │                                                   │  │
│ │            │ ┌───────────────────────────────────────────────┐│  │
│ │            │ │ Search & Filters                              ││  │
│ │            │ ├───────────────────────────────────────────────┤│  │
│ │            │ │ 🔍 Search skills by name (EN/JP)...           ││  │
│ │            │ │                                               ││  │
│ │            │ │ Status: [All ▼] [Owned] [Available] [Planned]││  │
│ │            │ │ Type: [All ▼] [Speed] [Stamina] [Power] ...  ││  │
│ │            │ │ Rarity: [All ▼] [Normal] [Rare] [Unique]     ││  │
│ │            │ │ Distance: [All ▼] [Sprint] [Mile] [Long]     ││  │
│ │            │ │ Running Style: [All ▼] [Nige] [Senkou] ...   ││  │
│ │            │ │                                               ││  │
│ │            │ │ Sort: [Recommended ▼] [Cost] [Name] [Type]   ││  │
...
│ │            │ │    Cost: 180 SP → 144 SP (2 hints)            ││  │
│ │            │ │    Priority: High | Match: 92%                ││  │
│ │            │ │    [VIEW DETAILS] [ACQUIRE]                   ││  │
│ │            │ │                                               ││  │
│ │            │ │ 2. Speed Star (Speed)                         ││  │
│ │            │ │    Cost: 120 SP → 96 SP (1 hint)              ││  │
...
│ │            │                                                   │  │
│ │            │ ┌───────────────────────────────────────────────┐│  │
│ │            │ │ Skill Catalog (128 skills shown)              ││  │
│ │            │ ├───────────────────────────────────────────────┤│  │
│ │            │ │ ┌─────────────────┬─────────────────────────┐ ││  │
│ │            │ │ │ Going Strong    │ Lane Guidance           │ ││  │
│ │            │ │ ├─────────────────┼─────────────────────────┤ ││  │
│ │            │ │ │ Normal | Speed  │ Normal | Speed/Wit      │ ││  │
│ │            │ │ │                 │                         │ ││  │
│ │            │ │ │ Base Cost: 120 SP│ Base Cost: 100 SP      │ ││  │
│ │            │ │ │ Hints: 2/3      │ Hints: 0/3             │ ││  │
│ │            │ │ │ Final: 96 SP ✓  │ Final: 100 SP          │ ││  │
│ │            │ │ │                 │                         │ ││  │
│ │            │ │ │ Distance: Mile+ │ Distance: Any          │ ││  │
│ │            │ │ │ Style: Sashi    │ Style: Any             │ ││  │
│ │            │ │ │                 │                         │ ││  │
│ │            │ │ │ Effect:         │ Effect:                │ ││  │
│ │            │ │ │ Final acceleration│ Lane change speed   │ ││  │
│ │            │ │ │ boost in last    │ improved, avoids      │ ││  │
│ │            │ │ │ 200m             │ blocking              │ ││  │
│ │            │ │ │                 │                         │ ││  │
│ │            │ │ │ [ACQUIRE] [PLAN]│ [ACQUIRE] [PLAN]       │ ││  │
│ │            │ │ │ [MORE INFO]     │ [MORE INFO]            │ ││  │
│ │            │ │ └─────────────────┴─────────────────────────┘ ││  │
│ │            │ │                                               ││  │
│ │            │ │ [Load More Skills] (12 of 128 shown)          ││  │
│ │            │ └───────────────────────────────────────────────┘│  │
│ └────────────┴───────────────────────────────────────────────────┘  │
└──────────────────────────────────────────────────────────────────────┘
...
│ ┌──────────────────────────────────────────────┐  │
│ │ SP Balance                                    │  │
│ │ Current: 450 | Earned: 2,400 | Spent: 1,950  │  │
│ │ Budget: 🟢 Healthy                           │  │
│ └──────────────────────────────────────────────┘  │
│                                                    │
│ ┌──────────────────────────────────────────────┐  │
    ...
    <div class="skill-card__cost">
        ...
        @if($hintCount > 0)
            <div class="hint-discount">
                <span class="hint-label">Hints: {{ $hintCount }}/3</span>
...
| Hint Count | Discount Percentage | Example (120 SP Base) |
|------------|---------------------|------------------------|
| 0 hints | 0% | 120 SP |
| 1 hint | 20% | 96 SP (-24) |
| 2 hints | 40% | 72 SP (-48) |
| 3+ hints | 40% (max) | 72 SP (-48) |
...
class SkillHintService
{
    ...
    {
        $hintCount = $this->getHintCount($skill, $character);
        $discount = $this->calculateDiscount($hintCount);
        
        return (int) ($skill->base_sp_cost * (1 - $discount));
    }
    
    public function getHintCount(Skill $skill, Character $character): int
    {
        return $character->skillHints()
            ->where('skill_id', $skill->id)
            ->where('is_used', false)
            ->sum('hint_level');
    }
    
    private function calculateDiscount(int $hintCount): float
    {
        return min(0.40, $hintCount * 0.20); // 20% per hint, 40% max
    }
}
```
            ...
            <div class="cost-breakdown">
                ...
                @if($hintCount > 0)
                    <div class="cost-row discount">
                        <span>Hint Discount ({{ $hintCount }} hints):</span>
...
<div aria-live="polite" aria-atomic="true" class="sr-only">
    AI recommends 3 skills for your build. Top recommendation: Endurance Master with 92% match score.
</div>
```
...
test('calculates hint discount correctly', function () {
    ...
    expect($finalCost)->toBe(72) // 120 * (1 - 0.40) = 72
        ->and($service->getHintCount($skill, $character))->toBe(2);
});
...
test('caps hint discount at 40%', function () {
    ...
    expect($finalCost)->toBe(72); // Still 72, not lower
});
```
...
test.describe('WF-008: Skill Shop Interface', () => {
    ...
    test('allows skill acquisition', async ({ page }) => {
        ...
        await page.getByTestId('skill-card-1').getByRole('button', { name: 'Acquire' }).click();
        
        // Verify success message
        await expect(page.getByRole('alert')).toContainText('Successfully acquired');
        
        // Verify SP balance updated
        await expect(page.getByTestId('sp-balance-widget')).toContainText(/Current SP: \d+/);
    });
...
*This wireframe specification reflects the current implementation of the Skill Shop Interface and serves as the authoritative reference for UI/UX development and testing.*
