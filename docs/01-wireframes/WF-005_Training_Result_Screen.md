...
│ │            │                                                   │  │
│ │ Dashboard  │ ┌──────────────────────────────────────────────┐ │  │
│ │ Character  │ │ Result Banner                                 │ │  │
│ │ Training ●│ │ ┌────────────────────────────────────────────┐│ │  │
│ │ Races      │ │ │ ✅ Training Success!                       ││ │  │
│ │ Skills     │ │ │ Speed Training completed successfully      ││ │  │
│ │ Support    │ │ └────────────────────────────────────────────┘│ │  │
│ │ AI Advisor │ └──────────────────────────────────────────────┘ │  │
│ │ Settings   │                                                   │  │
│ │            │ ┌──────────────────────┬────────────────────────┐│  │
...
│ │            │ ├──────────────────────┼────────────────────────┤│  │
│ │            │ │ Speed:   +48 (+3)🔺 │ Mejiro Dober           ││  │
│ │            │ │ Base:    +45         │ Bond: 78% → 85% (+7)   ││  │
│ │            │ │ Friendship: +3       │ Milestone: 80% reached!││  │
│ │            │ │                      │ Reward: Hint granted   ││  │
│ │            │ │ Stamina: +5          │                        ││  │
│ │            │ │ Power:   +3          │ Tokai Teio             ││  │
│ │            │ │ Guts:    +2          │ Bond: 70% → 75% (+5)   ││  │
│ │            │ │ Wit:     +1          │                        ││  │
│ │            │ │                      │ Kitasan Black          ││  │
│ │            │ │ Total Gain: +59 pts  │ Bond: 82% → 85% (+3)   ││  │
│ │            │ └──────────────────────┴────────────────────────┘│  │
│ │            │                                                   │  │
│ │            │ ┌──────────────────────┬────────────────────────┐│  │
│ │            │ │ Skill Hints Obtained │ Energy/Mood Changes    ││  │
│ │            │ ├──────────────────────┼────────────────────────┤│  │
│ │            │ │ ✨ Lane Guidance     │ Energy: 78% → 58%      ││  │
│ │            │ │ Guaranteed hint!     │ Cost: -20%             ││  │
│ │            │ │ SP Cost: 120 → 96    │ ████████████░░░░░░░░░░ ││  │
│ │            │ │ (2 hints, -40%)      │                        ││  │
│ │            │ │                      │ Mood: Good → Normal    ││  │
│ │            │ │ 💡 Going Strong      │ Modifier: +2% → 0%     ││  │
│ │            │ │ Random hint (25%)    │ 🙂 → 😐                ││  │
│ │            │ │ SP Cost: 120 → 96    │                        ││  │
│ │            │ │ (1 hint, -20%)       │ Condition: Normal      ││  │
│ │            │ │                      │ No debuffs             ││  │
│ │            │ └──────────────────────┴────────────────────────┘│  │
│ │            │                                                   │  │
│ │            │ ┌───────────────────────────────────────────────┐│  │
...
│ │            │ ┌───────────────────────────────────────────────┐│  │
│ │            │ │ Quick Actions                                 ││  │
│ │            │ │ [NEXT TRAINING] [VIEW CHARACTER] [ASK AI]     ││  │
│ │            │ └───────────────────────────────────────────────┘│  │
│ └────────────┴───────────────────────────────────────────────────┘  │
└──────────────────────────────────────────────────────────────────────┘
...
│ ┌──────────────────────────────────────────────┐  │
│ │ Bond Changes                                  │  │
│ │ • Mejiro Dober: 78% → 85% (+7) 🎉           │  │
│ │   Milestone: 80% Friendship Active           │  │
│ │ • Tokai Teio: 70% → 75% (+5)                 │  │
│ │ • Kitasan Black: 82% → 85% (+3)              │  │
│ └──────────────────────────────────────────────┘  │
│                                                    │
│ ┌──────────────────────────────────────────────┐  │
│ │ Skill Hints                                   │  │
...
```
SP Cost: 120 → 96 (2 hints, -40%)
SP Cost: 120 → 96 (1 hint, -20%)
```
...
<div aria-live="polite" aria-atomic="true" class="sr-only">
    Stat gains: Speed plus 48, Stamina plus 5, Power plus 3, Guts plus 2, Wit plus 1. Total gain: 59 points.
</div>

<!-- Bond changes announcement -->
<div aria-live="polite" aria-atomic="true" class="sr-only">
    Bond changes: Mejiro Dober increased by 7 to 85 percent. Milestone reached: 80 percent friendship training now active.
</div>

<!-- Skill hints announcement -->
<div aria-live="polite" aria-atomic="true" class="sr-only">
    Skill hints obtained: Lane Guidance guaranteed hint, Going Strong random hint.
</div>

<!-- Energy/mood announcement -->
<div aria-live="polite" aria-atomic="true" class="sr-only">
    Energy decreased from 78 percent to 58 percent. Mood changed from Good to Normal.
</div>
```
...
test.describe('WF-005: Training Result Screen', () => {
    test('displays training result correctly', async ({ page }) => {
        ...
        await expect(page.getByTestId('result-banner')).toContainText('Training Success');
...
test.describe('WF-005: Accessibility', () => {
    ...
    test('announces result to screen readers', async ({ page }) => {
        ...
        await expect(liveRegion).toContainText(/Training completed successfully/);
    });
...
*This wireframe specification reflects the current implementation of the Training Result Screen and serves as the authoritative reference for UI/UX development and testing.*
