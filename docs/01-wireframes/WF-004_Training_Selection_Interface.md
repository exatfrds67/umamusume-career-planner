...
│                                                                      │
│ ┌────────────┬───────────────────────────────────────────────────┐  │
│ │ Sidebar    │ Main Training Selection                           │  │
│ │            │                                                   │  │
│ │ Dashboard  │ ┌──────────────────────────────────────────────┐ │  │
│ │ Character  │ │ Current Status                                │ │  │
│ │ Training ●│ │ ┌────────────────────────────────────────────┐│ │  │
│ │ Races      │ │ │ Energy: ████████░░ 78% | Mood: Good 🙂    ││ │  │
│ │ Skills     │ │ │ Condition: Normal | Turn: 45/78            ││ │  │
│ │ Support    │ │ └──────────────────────────��─────────────────┘│ │  │
│ │ AI Advisor │ └──────────────────────────────────────────────┘ │  │
│ │ Settings   │                                                   │  │
│ │            │ ┌──────────────────────────────────────────────┐ │  │
│ │            │ │ 💡 AI Recommendation                          │ │  │
│ │            │ │ Focus on Speed training for upcoming G1 race  │ │  │
│ │            │ │ Confidence: 85% | Risk: Low                   │ │  │
│ │            │ └──────────────────────────────────────────────┘ │  │
│ │            │                                                   │  │
│ │            │ ┌───────────────────────────────────────────────┐│  │
│ │            │ │ Training Options (6 Facilities)               ││  │
│ │            │ ├───────────────────────────────────────────────┤│  │
│ │            │ │                                               ││  │
│ │            │ │ ┌─���───────────────────────────────────────┐ ││  │
│ │            │ │ │ 1. ⚡ SPEED TRAINING          [AI ✓]     │ ││  │
...
│ │            │ │ │                                           │ ││  │
│ │            │ │ │ Predicted Gains:                          │ ││  │
│ │            │ │ │ Speed:   +45  Stamina: +5   Power:  +3   │ ││  │
│ │            │ │ │ Guts:    +2   Wit:     +1                 │ ││  │
│ │            │ │ │                                           │ ││  │
│ │            │ │ │ Efficiency: ★★★★★ Excellent               │ ││  │
│ │            │ │ │                                           │ ││  │
│ │            │ │ │ Support Cards Active (3):                 │ ││  │
│ │            │ │ │ • Mejiro Dober (Power, +12, Red !) 🔴   │ ││  │
│ │            │ │ │ • Tokai Teio (Speed, +8)                  │ ││  │
│ │            │ │ │ • Kitasan Black (Stamina, +6)             │ ││  │
│ │            │ │ │                                           │ ││  │
│ │            │ │ │ Skill Hints:                              │ ││  │
...
│ │            │ │ │                                           │ ││  │
│ │            │ │ │ Risk: 🟢 Low (12%)                        │ ││  │
│ │            │ │ │ Energy Cost: -20% (78% → 58%)             │ ││  │
│ │            │ │ │ Mood Impact: Good → Normal (expected)     │ ││  │
│ │            │ │ │                                           │ ││  │
│ │            │ │ │ [TRAIN SPEED] [DETAILS]                   │ ││  │
│ │            │ │ └─────────────────────────────────────────┘ ││  │
│ │            │ │                                               ││  │
...
│ │            │ │ │                                           │ ││  │
│ │            │ │ │ Predicted Gains:                          │ ││  │
│ │            │ │ │ Speed:   +3   Stamina: +42  Power:  +2   │ ││  │
│ │            │ │ │ Guts:    +8   Wit:     +1                 │ ││  │
│ │            │ │ │                                           │ ││  │
│ │            │ │ │ Efficiency: ★★★★☆ Good                    │ ││  │
│ │            │ │ │                                           │ ││  │
│ │            │ │ │ Support Cards Active (2):                 │ ││  │
│ │            │ │ │ • Kitasan Black (Stamina, +15)            │ ││  │
│ │            │ │ │ • Symboli Rudolf (Guts, +8)               │ ││  │
│ │            │ │ │                                           │ ││  │
│ │            │ │ │ Skill Hints:                              │ ││  │
...
│ │            │ │ │                                           │ ││  │
│ │            │ │ │ [TRAIN STAMINA] [DETAILS]                 │ ││  │
│ │            │ │ └─────────────────────────────────────────┘ ││  │
│ │            │ │                                               ││  │
│ │            │ │ ┌─────────────────────────────────────────┐ ││  │
│ │            │ │ │ 3. 💪 POWER TRAINING                      │ ││  │
│ │            │ │ │ Recommendation Score: 65/100              │ ││  │
...
│ │            │ ┌───────────────────────────────────────────────┐│  │
│ │            │ │ Quick Actions                                 ││  │
│ │            │ │ [Skip Turn] [Rest] [Ask AI Advisor]           ││  │
│ │            │ └───────────────────────────────────────────────┘│  │
│ └────────────┴───────────────────────────────────────────────────┘  │
│                                                                      │
│ ┌────────────────────────────────────────────────────────────────┐  │
│ │ Right Panel: Current Run Snapshot                              │  │
│ ├────────────────────────────────────────────────────────────────┤  │
│ │ Stat Summary                                                   │  │
│ │ Speed:   A  (980)  ████████████████████                       │  │
│ │ Stamina: B+ (820)  ████████████████░░░░                       │  │
...
```html
<!-- Prediction card -->
<div role="article" aria-labelledby="prediction-speed" data-testid="prediction-card-speed">
    ...
    <div aria-label="Predicted stat gains">
        <span>Speed plus 45, Stamina plus 5, Power plus 3, Guts plus 2, Wit plus 1</span>
    </div>
    
    <!-- Support cards -->
    <div aria-label="Active support cards">
        <span>3 support cards active including Mejiro Dober with guaranteed skill hint</span>
    </div>
...
test.describe('WF-004: Training Selection Interface', () => {
    test('displays training predictions correctly', async ({ page }) => {
        ...
        await expect(page.getByTestId('training-header')).toContainText('Turn 45');
        ...
        await expect(speedCard.getByTestId('ai-recommended-badge')).toBeVisible();
        
        // Check stat gains display
        await expect(speedCard.getByTestId('stat-gains')).toBeVisible();
        await expect(speedCard.getByTestId('stat-gains')).toContainText('Speed: +45');
    });
    ...
    test('supports keyboard navigation', async ({ page }) => {
        ...
        await expect(page.getByTestId('prediction-card-speed')).toHaveAttribute('aria-expanded', 'true');
...
*This wireframe specification reflects the current implementation of the Training Selection Interface and serves as the authoritative reference for UI/UX development and testing.*
