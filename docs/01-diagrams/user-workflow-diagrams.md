...
- **Step**: Select Character; **Description**: Choose trainee from character database; **Validation Rules**: Required selection
- **Step**: Set Character Goals; **Description**: Define target stats (0-1200 range); **Validation Rules**: Stat values within valid range
- **Step**: Configure Support Deck; **Description**: Build 6-card deck (5 owned + 1 borrowed); **Validation Rules**: Exactly 6 cards required
- **Step**: Configure Legacy Team; **Description**: Select inheritance parents; **Validation Rules**: 2 parents + 4 grandparents
- **Step**: Calculate Inheritance; **Description**: Apply factor bonuses (★☆☆=+5, ★★☆=+12, ★★★=+21); **Validation Rules**: Valid factor ratings
- **Step**: Review Setup Summary; **Description**: Verify all selections; **Validation Rules**: All required fields complete
...
- **Component**: Base Gains; **Description**: Raw stat increases from training type; **Cache TTL**: 5 minutes
- **Component**: Support Bonuses; **Description**: Multipliers from active support cards; **Cache TTL**: 5 minutes
- **Component**: Failure Risk; **Description**: Chance of training failure (0-90%); **Cache TTL**: Real-time
- **Component**: Hint Chance; **Description**: Probability of receiving skill hints; **Cache TTL**: 5 minutes
- **Component**: Bond Gains; **Description**: Friendship points with support cards; **Cache TTL**: 5 minutes

### 2.5 Risk Level Indicators

- **Risk Level**: Low; **Percentage**: <15%; **Indicator**: 🟢 Green; **Action**: Safe to proceed
- **Risk Level**: Moderate; **Percentage**: 15-40%; **Indicator**: 🟡 Amber; **Action**: Consider alternatives
- **Risk Level**: High; **Percentage**: >40%; **Indicator**: 🔴 Red; **Action**: Rest recommended
...
- **Readiness Score**: ≥85%; **Classification**: Excellent; **Indicator**: 🟢 Ready
- **Readiness Score**: 70-84%; **Classification**: Good; **Indicator**: 🟡 Prepared
- **Readiness Score**: 55-69%; **Classification**: Fair; **Indicator**: 🟠 Borderline
- **Readiness Score**: <55%; **Classification**: Poor; **Indicator**: 🔴 Not Ready

### 3.5 Aptitude Effectiveness

- **Rating**: S; **Effectiveness**: +5%; **Description**: Maximum aptitude (provides positive bonus)
- **Rating**: A; **Effectiveness**: 0%; **Description**: Standard aptitude (baseline)
- **Rating**: B; **Effectiveness**: 90%; **Description**: Below average
- **Rating**: C; **Effectiveness**: 80%; **Description**: Poor aptitude
- **Rating**: D; **Effectiveness**: 70%; **Description**: Very poor
- **Rating**: E; **Effectiveness**: 60%; **Description**: Extremely poor
- **Rating**: F; **Effectiveness**: 50%; **Description**: Minimal
- **Rating**: G; **Effectiveness**: 40%; **Description**: Worst possible
...
- **Provider**: Ollama; **Model**: Local Models (llama3.2); **Use Case**: Simple queries, high volume; **Cost**: Free
- **Provider**: AWS Bedrock; **Model**: Claude Haiku; **Use Case**: Standard recommendations; **Cost**: $0.25/1M input
- **Provider**: AWS Bedrock; **Model**: Claude Sonnet; **Use Case**: Complex strategy analysis; **Cost**: $3/1M input
- **Provider**: AWS Bedrock; **Model**: Claude Opus; **Use Case**: Advanced reasoning (fallback); **Cost**: $5/1M input

### 4.5 Neuron Agent Tools

- **Agent**: Training Advisor; **Primary Tools**: GetCharacterStatsTool, GetTrainingPredictionsTool; **Purpose**: Training recommendations
- **Agent**: Race Strategy; **Primary Tools**: GetRaceRequirementsTool, GetAptitudeAnalysisTool; **Purpose**: Race preparation
- **Agent**: Skill Advisor; **Primary Tools**: GetSkillCatalogTool, GetSkillHintsTool; **Purpose**: Skill acquisition planning
- **Agent**: Career Planning; **Primary Tools**: GetGoalProgressTool, GetCareerTimelineTool; **Purpose**: Long-term strategy
...
- **Data Type**: Character stats; **Detection Pattern**: Stat labels + numeric values; **Minimum Confidence**: 85%
- **Data Type**: Skill names; **Detection Pattern**: Japanese/English text regions; **Minimum Confidence**: 80%
- **Data Type**: Race results; **Detection Pattern**: Placement + time format; **Minimum Confidence**: 90%
- **Data Type**: Support cards; **Detection Pattern**: Card frame detection; **Minimum Confidence**: 75%

### 5.5 Preprocessing Operations

- **Operation**: Resize; **Purpose**: Normalize dimensions; **Implementation**: Max 2000px width
- **Operation**: Grayscale; **Purpose**: Improve contrast; **Implementation**: GD `imagefilter()`
- **Operation**: Threshold; **Purpose**: Binary conversion; **Implementation**: Adaptive threshold
- **Operation**: Deskew; **Purpose**: Correct rotation; **Implementation**: Angle detection
- **Operation**: Denoise; **Purpose**: Remove artifacts; **Implementation**: Median filter
...
- **Format**: JSON; **Extension**: .json; **Use Case**: Full backup with schema; **Size Limit**: No limit
- **Format**: Excel; **Extension**: .xlsx; **Use Case**: Spreadsheet analysis; **Size Limit**: 50k rows
- **Format**: CSV; **Extension**: .csv; **Use Case**: Data processing; **Size Limit**: No limit

### 6.4 Conflict Resolution Strategies

- **Strategy**: Skip; **Behavior**: Keep existing, ignore imported; **Use Case**: Preserve user modifications
- **Strategy**: Overwrite; **Behavior**: Replace existing with imported; **Use Case**: Fresh data sync
- **Strategy**: Rename; **Behavior**: Create new with modified identifier; **Use Case**: Keep both versions
...
- **Feature**: Login Required; **Local Mode 🟠**: No; **Account Mode 🟣**: Yes
- **Feature**: Data Location; **Local Mode 🟠**: Browser localStorage; **Account Mode 🟣**: MySQL Database
- **Feature**: Offline Support; **Local Mode 🟠**: Full; **Account Mode 🟣**: Draft only
- **Feature**: Cross-Device; **Local Mode 🟠**: No; **Account Mode 🟣**: Yes
- **Feature**: Identifier; **Local Mode 🟠**: UUID; **Account Mode 🟣**: Integer ID
- **Feature**: Storage Limit; **Local Mode 🟠**: 5-10MB; **Account Mode 🟣**: Unlimited
- **Feature**: Data Risk; **Local Mode 🟠**: Browser cache clear; **Account Mode 🟣**: Server backup

### 7.4 Draft Auto-Save Configuration

- **Setting**: Auto-save Interval; **Value**: 30 seconds; **Description**: Time between saves
- **Setting**: Draft Versions; **Value**: 3; **Description**: Maximum versions kept
- **Setting**: Draft Expiration; **Value**: 7 days; **Description**: Prompt after this period
- **Setting**: Clear on Save; **Value**: Yes; **Description**: Remove drafts after successful save
...
- **Workflow**: Career Setup; **Description**: Character, deck, and goal configuration; **Primary Documents**: PRD-001, SPEC-001, FLOW-001
- **Workflow**: Turn-by-Turn Training; **Description**: Core gameplay with AI recommendations; **Primary Documents**: PRD-002, SPEC-002, FLOW-002
- **Workflow**: Race Preparation; **Description**: Strategy and readiness optimization; **Primary Documents**: PRD-003, SPEC-003, FLOW-003
- **Workflow**: AI Advisory; **Description**: Intelligent recommendations via Neuron agents; **Primary Documents**: PRD-006, SPEC-006, FLOW-006
- **Workflow**: Screenshot Analysis; **Description**: OCR-based data extraction; **Primary Documents**: SPEC-007, FLOW-007
- **Workflow**: Data Import/Export; **Description**: Backup, restore, and migration; **Primary Documents**: D05, D06
- **Workflow**: Storage Modes; **Description**: Local/Account mode management; **Primary Documents**: SRS FR-10, User Manual

### 8.2 Critical Decision Points

- **Decision Point**: AI Model Selection; **Options**: Ollama local vs AWS Bedrock; **Impact**: Cost, response time, availability
- **Decision Point**: Training Selection; **Options**: 5 training types + rest; **Impact**: Stat development, energy management
- **Decision Point**: Race Strategy; **Options**: 4 running styles; **Impact**: Win probability, skill activation
- **Decision Point**: Storage Mode; **Options**: Local vs Account; **Impact**: Offline capability, data persistence
- **Decision Point**: Data Validation; **Options**: Accept/Review/Reject; **Impact**: Data accuracy, user intervention

### 8.3 Integration Points

- **Integration**: AI Chatbot; **Service**: Neuron AI Agents; **Purpose**: Contextual advice across all workflows
- **Integration**: OCR Pipeline; **Service**: Tesseract + GD; **Purpose**: Automated data input from screenshots
- **Integration**: External APIs; **Service**: umapyoi.net, GameTora; **Purpose**: Game data synchronization
- **Integration**: WebSocket; **Service**: Laravel Reverb; **Purpose**: Real-time updates
- **Integration**: Caching; **Service**: Redis; **Purpose**: Performance optimization

### 8.4 Performance Targets

- **Metric**: Training Prediction; **Target**: < 1.2s (p95); **Workflow**: Turn-by-Turn Training
- **Metric**: AI Advisory Response; **Target**: < 2.5s; **Workflow**: AI Chatbot Interaction
- **Metric**: OCR Processing; **Target**: < 5s; **Workflow**: Screenshot Analysis
- **Metric**: Export (50k rows); **Target**: < 60s; **Workflow**: Data Export
- **Metric**: Page Load; **Target**: < 2s; **Workflow**: All workflows

---

## Document Control

- **Version**: 2.4.0; **Date**: 2026-02-22; **Author**: Development Team; **Changes**: Added Neuron AI v2.11 version; updated model names (Claude Haiku/Sonnet/Opus); updated external API references (GameTora); updated stats
...
- **Version**: 2.1.0; **Date**: 2026-01-24; **Author**: Development Team; **Changes**: Complete rewrite aligned with v2.0.0 codebase, updated AI integration to Neuron agents, added storage mode and import/export flows, updated technical specifications
- **Version**: 2.0.0; **Date**: 2026-01-14; **Author**: Development Team; **Changes**: Prior revision with initial workflow diagrams
