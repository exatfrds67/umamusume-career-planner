...
Successfully completed systematic fixes of all critical documentation files containing incorrect
game mechanics information. All user-facing and developer documentation now aligns with verified
game mechanics from Umamusume Pretty Derby (Global English Server, January 2026).
...
2. **docs/verification-reports/requirements.md**
   - Fixed: "20% SP cost reduction per duplicate hint" → "progressive SP cost reduction (5 levels:
   10%/20%/30%/35%/40% max)"
...
Successfully completed systematic fixes of all critical documentation files. The Umamusume Career
Planner documentation now accurately reflects verified game mechanics from the Global English Server
(January 2026).
...
**Source of Truth**: `docs/research/game-mechanics-research-report.md` remains the authoritative
reference for all game mechanics, with citations to official and community sources.
