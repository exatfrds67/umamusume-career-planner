...
This document provides a comprehensive verification table for all technologies referenced in the Umamusume Career Planner project documentation. All technologies have been verified for current availability, compatibility, and pricing as of February 22, 2026.

### Key Findings

- **All Core Technologies**: ✅ Verified and current
- **Deprecated APIs**: ❌ SimpleSandman/UmaMusumeAPI replaced with umapyoi.net
- **External Data Sources**: umapyoi.net (primary) + GameTora (secondary)
- **Pricing Accuracy**: ✅ All AWS Bedrock pricing verified
- **Package Compatibility**: ✅ All Laravel 12 packages verified
- **Codebase Scale**: 30 models, 56 migrations, 571 routes, 3,316+ tests, 11,563+ assertions
- **Services**: 70+ services across AI/, MCP/, Neuron/, Training/, ExternalAPI/, OCR/
...
## 2. Core Framework Technologies
 ...
 | **PHP** | 8.2+ (runtime 8.4.11) | November 23, 2023 | ✅ **VERIFIED** | Required extensions: PDO, Redis, GD, Imagick, OpenSSL |
...
### Framework Package Verification
 ...
 | **livewire/livewire** | v4.x | Laravel 12 ✅ | ✅ **VERIFIED** | Full-stack reactive components |
 | **pestphp/pest** | v4.x | Laravel 12 ✅ | ✅ **VERIFIED** | Testing framework (browser testing) |
 | **phpunit/phpunit** | v12.x | Laravel 12 ✅ | ✅ **VERIFIED** | Unit testing (via Pest) |
 | **laravel/pint** | v1.x | Laravel 12 ✅ | ✅ **VERIFIED** | Code formatting |
 | **alpinejs** | v3.x | Livewire 4 ✅ | ✅ **VERIFIED** | Lightweight JS framework |
...
### Local AI Processing
 ...
 | **Neuron AI** | v2.11 | ✅ **VERIFIED** | AI agent framework for Laravel, multi-provider support |

### Cloud AI Processing (AWS Bedrock)

 | Model | Pricing (Input/Output per 1M tokens) | Status | Verification Date |
 | ------- | -------------------------------------- | -------- | ------------------ |
| **Claude 4.5 Opus** | $5.00 / $25.00 | ✅ **VERIFIED** | February 22, 2026 |
 | **Claude 4.5 Sonnet** | $3.00 / $15.00 | ✅ **VERIFIED** | February 22, 2026 |
 | **Claude 4.5 Haiku** | $1.00 / $5.00 | ✅ **VERIFIED** | February 22, 2026 |
 | **Nova 2 Lite** | $0.00125 / $0.00125 (per 1K tokens) | ✅ **VERIFIED** | February 22, 2026 |
 | **Nova 2 Pro** | Preview | ⚠️ **PREVIEW** | February 22, 2026 |
...
### Game Data APIs
 ...
 | **GameTora** | ✅ **ACTIVE** | Community calculator tools, meta analysis, and game data reference | Replaces UmamusumeDB.com as secondary source |

### API Integration Strategy

 | Integration Type | Primary | Secondary | Fallback |
 | ------------------ | --------- | ----------- | ---------- |
| **Character Data** | umapyoi.net | GameTora | Manual input |
 | **Support Cards** | umapyoi.net | GameTora | Manual input |
 | **Meta Rankings** | GameTora | umapyoi.net | Community sources |
...
### Code Quality and Testing
 ...
 | **Pest PHP** | v4.x | ✅ **VERIFIED** | Testing framework (browser testing, smoke testing) |
 | **PHPUnit** | v12.x | ✅ **VERIFIED** | Unit testing (via Pest) |
...
| **GD Extension** | PHP 8.2+ | ✅ **VERIFIED** | Image manipulation |
 | **Imagick Extension** | PHP 8.2+ | ✅ **VERIFIED** | Advanced image processing |
...
- **Core Framework**: Laravel 12, PHP 8.2+ (runtime 8.4.11), Livewire 4, Alpine.js 3, Tailwind CSS v4, MySQL 8.0+, Redis 7.0+
- **AI Integration**: Neuron AI v2.11, cloudstudio/ollama-laravel, AWS Bedrock models with verified pricing
- **MCP Servers**: All 10 MCP servers verified and available
- **Testing**: Pest v4 (3,316+ tests, 11,563+ assertions), PHPUnit v12
...
- **Codebase**: 30 models, 56 migrations, 571 routes, 70+ services
...
1. **API Migration**: Complete migration from SimpleSandman/UmaMusumeAPI to umapyoi.net ✅ Done
2. **GameTora Integration**: GameTora confirmed active as secondary data source ✅ Done
...
## Document Control
 ...
 | 2.0 | 2026-02-22 | Development Team | Updated package versions (Pest v4, PHPUnit v12, Livewire 4, Neuron AI v2.11), replaced UmamusumeDB with GameTora, updated model/test counts (30 models, 3,316+ tests) |
