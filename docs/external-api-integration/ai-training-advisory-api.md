...
The AI Training Advisory System provides RESTful API endpoints for generating intelligent
recommendations during Umamusume Pretty Derby career runs. All endpoints support both Local Mode
(browser storage) and Account Mode (database) operations.
  ...
  "recommendations": [
    {
      ...
      "reasoning": "3 support cards present (Friendship Training available), facility at Level 3, aligns
      with upcoming Medium race requirements",
      "expected_outcomes": {
        "speed_gain": "+45-55",
