...
The Redis "Class not found" error has been completely resolved by switching from XAMPP (PHP 8.2.12) to PHP's built-in server (PHP 8.4.11). The application is now fully operational with excellent performance metrics.
