...
### Formula Components
- **Component**: **Base**; **Description**: Base stat gain from training type; **Range**: 10-25 per stat
- **Component**: **StatBonus**; **Description**: Support card stat bonuses; **Range**: 0-50+
- **Component**: **GrowthRate**; **Description**: Character-specific growth rate; **Range**: 0-20% per stat
- **Component**: **MoodMultiplier**; **Description**: Mood effect multiplier; **Range**: -0.2 to +0.2
- **Component**: **MoodEffect**; **Description**: Additional mood bonuses; **Range**: 0-10%
- **Component**: **TrainingEffect**; **Description**: Facility level bonus; **Range**: 0-100%
- **Component**: **NumSupportCards**; **Description**: Cards present at training; **Range**: 0-6
- **Component**: **FriendshipMultiplier**; **Description**: Friendship training bonus; **Range**: 1.0-1.35×

### 2.2 Facility Level Multipliers

Training facilities have 5 levels with progressive multipliers:

- **Level**: 1; **Multiplier**: 1.00×; **Training Effect**: +0%
- **Level**: 2; **Multiplier**: 1.25×; **Training Effect**: +25%
- **Level**: 3; **Multiplier**: 1.50×; **Training Effect**: +50%
- **Level**: 4; **Multiplier**: 1.75×; **Training Effect**: +75%
- **Level**: 5; **Multiplier**: 2.00×; **Training Effect**: +100%
...
- **Stat Range**: 0-1200; **Gain Multiplier**: 100%; **Per-Training Cap**: +100 max
- **Stat Range**: 1200+; **Gain Multiplier**: 50%; **Per-Training Cap**: +50 max
...
- **Condition**: Base (training together); **Bond Gain**: +7
- **Condition**: With Charming condition; **Bond Gain**: +9

### Friendship Training
- **Threshold**: Activation; **Requirement**: Bond ≥ 80% (80 points)
- **Threshold**: Visual Indicator; **Requirement**: Rainbow glow on card

### Friendship Bonus by Card Rarity
- **Rarity**: R; **Friendship Bonus**: +10%
- **Rarity**: SR; **Friendship Bonus**: +15%
- **Rarity**: SSR; **Friendship Bonus**: +20-35%

### 2.5 Support Card Presence Bonus

Each support card present at training adds a stacking bonus:

- **Cards Present**: 0; **Total Bonus**: +0%
- **Cards Present**: 1; **Total Bonus**: +5%
- **Cards Present**: 2; **Total Bonus**: +10%
- **Cards Present**: 3; **Total Bonus**: +15%
- **Cards Present**: 4; **Total Bonus**: +20%
- **Cards Present**: 5; **Total Bonus**: +25%
- **Cards Present**: 6; **Total Bonus**: +30%

### 2.6 Training Types and Stat Distribution

Each training type affects multiple stats:

- **Training**: Speed; **Primary Stat**: Speed (100%); **Secondary Stats**: Power (partial), Stamina (partial)
- **Training**: Stamina; **Primary Stat**: Stamina (100%); **Secondary Stats**: Guts (partial), Power (partial)
- **Training**: Power; **Primary Stat**: Power (100%); **Secondary Stats**: Stamina (partial), Guts (partial)
- **Training**: Guts; **Primary Stat**: Guts (100%); **Secondary Stats**: Power (partial), Wit (partial)
- **Training**: Wit; **Primary Stat**: Wit (100%); **Secondary Stats**: Speed (partial), Stamina (partial)
...
- **Component**: **User**; **Type**: Actor; **Responsibility**: Initiates training selection and execution
- **Component**: **Livewire Component**; **Type**: Presentation; **Responsibility**: `TrainingSelector.php` - Training interface
- **Component**: **TrainingController**; **Type**: Application; **Responsibility**: Orchestrates training workflow
- **Component**: **TrainingPredictionService**; **Type**: Domain Service; **Responsibility**: Generates training predictions
- **Component**: **TrainingExecutionService**; **Type**: Domain Service; **Responsibility**: Executes training and updates state
- **Component**: **StatCalculator**; **Type**: Domain Service; **Responsibility**: Calculates base stat gains with game formula
- **Component**: **SupportBonusCalculator**; **Type**: Domain Service; **Responsibility**: Applies support card bonuses
- **Component**: **BondProgressionService**; **Type**: Domain Service; **Responsibility**: Calculates bond gains and friendship status
- **Component**: **SoftCapCalculator**; **Type**: Domain Service; **Responsibility**: Applies stat soft cap rules
- **Component**: **RiskCalculator**; **Type**: Domain Service; **Responsibility**: Determines failure probability
- **Component**: **Database**; **Type**: Infrastructure; **Responsibility**: MySQL/MariaDB persistence layer
- **Component**: **Cache**; **Type**: Infrastructure; **Responsibility**: Redis prediction cache
- **Component**: **EventDispatcher**; **Type**: Infrastructure; **Responsibility**: Laravel event broadcasting
- **Component**: **WebSocketService**; **Type**: Infrastructure; **Responsibility**: Laravel Reverb real-time updates
...
- **Phase**: **Cache Check**; **Duration**: ~10ms; **Description**: Redis cache lookup
- **Phase**: **Prediction Calculation**; **Duration**: ~150ms; **Description**: Full formula + bonuses + soft cap + risk + hints
- **Phase**: **Cache Store**; **Duration**: ~5ms; **Description**: Write to Redis
- **Phase**: **User Selection**; **Duration**: Variable; **Description**: User decision time
- **Phase**: **Authorization**; **Duration**: ~20ms; **Description**: User permission check
- **Phase**: **Formula Application**; **Duration**: ~50ms; **Description**: Complete training formula calculation
- **Phase**: **Soft Cap Check**; **Duration**: ~5ms; **Description**: Apply diminishing returns above 1200
- **Phase**: **Bond Calculation**; **Duration**: ~10ms; **Description**: Calculate +7/+9 bond gains
- **Phase**: **Database Transaction**; **Duration**: ~200ms; **Description**: Stat updates + bond updates + history inserts
- **Phase**: **Event Dispatch**; **Duration**: ~30ms; **Description**: Queue event listeners
- **Phase**: **WebSocket Broadcast**; **Duration**: ~50ms; **Description**: Real-time update to clients
- **Phase**: **UI Update**; **Duration**: ~100ms; **Description**: Animation and state refresh
- **Phase**: **Total (Prediction)**; **Duration**: ~200ms; **Description**: Server-side processing
- **Phase**: **Total (Execution)**; **Duration**: ~300ms; **Description**: Server-side processing
...
- **Error Code**: `TRAIN_001`; **Condition**: Career not found; **HTTP Status**: 404; **User Message**: "Career run not found"
- **Error Code**: `TRAIN_002`; **Condition**: Invalid facility type; **HTTP Status**: 422; **User Message**: "Invalid training facility selected"
- **Error Code**: `TRAIN_003`; **Condition**: Insufficient energy; **HTTP Status**: 422; **User Message**: "Not enough energy to train (minimum 10 required)"
- **Error Code**: `TRAIN_004`; **Condition**: Career completed; **HTTP Status**: 422; **User Message**: "Cannot train on completed career"
- **Error Code**: `TRAIN_005`; **Condition**: Turn limit exceeded; **HTTP Status**: 422; **User Message**: "Career has reached maximum turn limit (78)"
- **Error Code**: `TRAIN_006`; **Condition**: Invalid facility level; **HTTP Status**: 422; **User Message**: "Facility level must be between 1 and 5"
...
- **Scenario**: Constraint violation; **Trigger**: Stat exceeds max (prevented by soft cap); **Recovery**: Rollback, log error
- **Scenario**: Deadlock; **Trigger**: Concurrent training execution; **Recovery**: Rollback, retry with delay
- **Scenario**: Cache failure; **Trigger**: Redis unavailable; **Recovery**: Proceed without cache, log warning
- **Scenario**: Event dispatch failure; **Trigger**: WebSocket unavailable; **Recovery**: Complete transaction, queue event for retry
- **Scenario**: Bond update failure; **Trigger**: Invalid card reference; **Recovery**: Rollback, log error
...
- **Operation**: Prediction generation (cache miss); **Target**: <1.2s; **Current**: ~1.1s; **Status**: ✅ Met
- **Operation**: Prediction generation (cache hit); **Target**: <200ms; **Current**: ~150ms; **Status**: ✅ Met
- **Operation**: Training formula calculation; **Target**: <100ms; **Current**: ~50ms; **Status**: ✅ Met
- **Operation**: Soft cap calculation; **Target**: <10ms; **Current**: ~5ms; **Status**: ✅ Met
- **Operation**: Bond calculation; **Target**: <20ms; **Current**: ~10ms; **Status**: ✅ Met
- **Operation**: Training execution; **Target**: <300ms; **Current**: ~280ms; **Status**: ✅ Met
- **Operation**: WebSocket broadcast; **Target**: <100ms; **Current**: ~50ms; **Status**: ✅ Met
- **Operation**: Total user flow (selection + execution); **Target**: <2s; **Current**: ~1.8s; **Status**: ✅ Met
...
- **Document**: [PRD-002](../prds/PRD-002_Training_Optimization.md); **Description**: Product requirements for training system
- **Document**: [SPEC-002](../specs/SPEC-002_Training_Optimization_Technical.md); **Description**: Technical specification for training optimization
- **Document**: [FLOW-002](../flows/FLOW-002_Training_Optimization_System.md); **Description**: System flow for training operations
- **Document**: [TECH-FLOW-002](../tech-flow/TECH-FLOW-002_Training_Optimization_Flow.md); **Description**: Technical flow diagrams

### 9.2 Related Sequences

- **Sequence**: [SEQ-001](SEQ-001_Character_Creation_Sequence.md); **Description**: Character creation (sets initial stats)
- **Sequence**: [SEQ-003](SEQ-003_Skill_Acquisition_and_Upgrade.md); **Description**: Skill acquisition (uses hints from training)
- **Sequence**: [SEQ-005](SEQ-005_Support_Card_Upgrade.md); **Description**: Support card upgrades (affects bonuses)

### 9.3 UI Documentation

- **Document**: [WF-004](../wireframes/WF-004_Training_Selection_Interface.md); **Description**: Wireframe specification for training selection
- **Document**: [WF-005](../wireframes/WF-005_Training_Result_Screen.md); **Description**: Training result display wireframe
- **Document**: [UF-003](../user-flows/UF-003_Training_Day_Flow.md); **Description**: User flow for training day
...
- **Source**: Global English Server; **Description**: Verified mechanics (January 2026)
- **Source**: [Game Mechanics Research Report](../research/game-mechanics-research-report.md); **Description**: Detailed formula analysis
...
- **Version**: 2.2.0; **Date**: 2026-02-22; **Author**: Development Team; **Changes**: Updated with verified game mechanics from Global English Server - added complete training formula, corrected facility multipliers (1.0×-2.0×), updated bond mechanics (+7 base, +9 Charming), soft cap at 1200 with 50% reduction, friendship training threshold at 80% bond, support card presence bonus (+5% per card), Summer Training Camp mechanics
- **Version**: 2.0.0; **Date**: 2026-01-24; **Author**: Development Team; **Changes**: Complete rewrite aligned with v2.0.0 implementation; added detailed sequence flows, caching strategy, WebSocket integration, performance metrics, and aligned with current Laravel 12 architecture
